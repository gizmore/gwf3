...
$lang = array(
	'info' =>
		...
		'<br/>'.
		'You drive with your van to the bank\'s main office, and setup your favourite wireless sniffing tool. Wow, it looks like they are using some WPA network. Let\'s sniff <a href="%1%">some data</a>, and try to crack the WPA password with some dictionary attack.<br/>'.
		'<br/>'.
		'<br/>'.
	...
	'info_login' =>
		...
		'Now you can do some easy arp cache poisoning, <a href="%1%">sniff some authentication data</a> (username and the one time password generated by the PSA InsecurID token) and replay it to the authentication page.<br/>'.
		'You have 3 seconds to do that.<br/>'.
		'<br/>'.
		'submit the text to %2%<br/>'.
		'Your timelimit is %3% seconds.',

	'failed' => 'Login failed, invalid username or password.',
	'not_sniffed_yet' => 'Error: you have not sniffed the data yet.',

	'info_2' =>
		'Good job. Now you have succesfully uploaded the <a href="%1%">new token data</a> for the victims bank account. '.
