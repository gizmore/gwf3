...
final class Chicago_University extends SR_Location
{
	...
	public function getFoundText(SR_Player $player) { return 'You found the University of Chicago. The facade leaves a good impression in these bad times.'; }
	public function getEnterText(SR_Player $player) { return 'You enter the university and see a gnome study in a corner.'; }
