...
final class GWF_Log
{
	...
	public static function isEnabled($bits) { return self::$logbits & $bits === $bits; }
	public static function isDisabled($bits) { return self::$logbits & $bits !== $bits; }
	...
	private static function createLogDir($filename)
	{
		...
		return (false !== is_dir($dir) && (false !== @mkdir($dir, GWF_CHMOD, true)));
	}
