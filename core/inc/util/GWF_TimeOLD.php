...
//	}
	...
	public static function displayDateFormat($gdo_date, $format, $iso=NULL)
	{
		if ($iso === NULL)
		{
	...
	private static function displayDateFormatB($gdo_date, $format, $default_return, $m_names, $month_names, $d_names, $day_names, $unknown='Unknown')
	{
		$replace = array();
...
//				}
	...
	public static function displayDateISO($gdo_date, $iso, $default_return='ERROR')
	{
		...
		return self::displayDateFormatB($gdo_date, $format, $default_return, $cache[$iso][0], $cache[$iso][1], $cache[$iso][2], $cache[$iso][3]);
	}
