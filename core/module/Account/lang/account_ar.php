...
$lang = array(
    ...
    # Titles
    'form_title' => 'اعدادات الحساب',
    'chmail_title' => 'دخل ايميلك',
    ...
    'th_countryid' => 'الدولة',
    'th_langid' => 'اللغة الأم',
    'th_langid2' => 'اللغة الثانية',
    'th_birthdate' => 'تاريخ ميلادك',
    'th_gender' => 'نوعك',
    'th_flags' => 'اختياري - You can toggle these on the fly',
    'th_adult' => 'هل تريد ان تري مواد اباحية',
    'th_online' => 'اظهار حالة الأتصال الخاصة بك',
    'th_show_email' => 'اظهر ايميلك لعامة الشعب',
    'th_avatar' => 'الافاتار الخاص بك',
    'th_approvemail' => '<b>هذا الايميل غير مسموح به</b>',
    'th_email_new' => 'ايميلك الجديد',
    'th_email_re' => 'دخل الايميل كمان مرة',

    # Buttons
    'btn_submit' => 'احفظ التغيرات',
    'btn_approvemail' => 'اكد الايميل',
    'btn_changemail' => 'دخل ايميل جديد',
    'btn_drop_avatar' => 'ألغي الافاتار',

    # Errors
    'err_token' => 'توكن مش شغالة.',
    'err_email_retype' => 'اصطبح, ودخل الايميل بشكل كويس',
    'err_delete_avatar' => 'مشكلة حصلة وانت بتلغي الافاتار',
    'err_no_mail_to_approve' => 'ياعم ركز احب علي راسك ودخل الايميل',
    'err_already_approved' => 'الايميل ده متاخد',
    'err_no_image' => 'الملف اللي رفعته ده مش صورة, او حجمة صغير',
    'err_demo_wait' => 'You changed your demographic options recently. Please wait %s.',
    'err_birthdate' => 'تاريخ الميلاد مش مظبوط',
...
# --- EMAIL BELOW HERE --- #
    ...
    'th_date' => 'التاريخ',
    'th_ua' => 'اليوزر ايجينت بتاعة المتصفح',
    'th_ip' => 'عنوان الاي بي',
    'th_isp' => 'اسم الجهاز',
);