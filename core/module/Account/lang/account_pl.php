...
$lang = array(
	...
	'th_demo' => 'Ustawienia główne - Możesz je zmienić tylko raz na %1%.',
	'th_countryid' => 'Kraj',	
	...
	'err_demo_wait' => 'Już zmieniłeś(aś) swoje główne ustawienia. Odczekaj %1%.',
	'err_birthdate' => 'Twoja data urodzin jest niepoprawna.',

	# Messages
	'msg_mail_changed' => 'Twój email kontaktowy został zmieniony na <b>%1%</b>.',
...
# --- EMAIL BELOW HERE --- #
	...
	'chdemo_body' =>
		...
		'Możesz to zrobić tylko raz w ciągu %2%, więc przed kontynuacją sprawdź czy informacje są poprawne.'.PHP_EOL.
		PHP_EOL.
		'Płeć: %3%'.PHP_EOL.
		'Kraj: %4%'.PHP_EOL.
		'Główny język: %5%'.PHP_EOL.
		'Dodatkowy język: %6%'.PHP_EOL.
		'Data urodzin: %7%'.PHP_EOL.
		PHP_EOL.
