<?php
final class Account_Access extends GWF_Method
{
	...
	{
		$tVars = array(
			'sort_url' => $this->getMethodHREF('by=%BY%&dir=%DIR%'),
			'page_menu' => GWF_PageMenu::display($this->page, $this->nPages, $this->getMethodHREF("by=$this->by&dir=$this->dir&page=%PAGE%")),
			'result' => $this->result,
			'table' => $this->table,
		);
		return $this->module->templatePHP('access.php', $tVars);
	}
