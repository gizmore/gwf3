...
$lang = array(
	...
	# Info
	'install_info' => 'Some modules need update, you can <a href="%1$s">Update and Install all Modules</a> too.',
	'info_methods' => 'Checking %1$s Methods in the Module...',
	
	# Select
	'sel_group' => 'Select Usergroup',
	
	# Titles
	'form_title' => 'Configure %1$s',
	...
	'ft_useredit' => 'Edit the User %1$s',
	'ft_search' => 'Search in the user table.',
	'ft_edit_group' => 'Edit Group %1$s',
	...
	'err_not_installed' => 'Module %1$s is not installed yet.',
	'err_arg_script' => 'You can not change the value for &quot;%1$s&quot; by hand.',
	'err_arg_type' => 'Wrong arguments for &quot;%1$s&quot;.',
	'err_arg_range' => 'The value for &quot;%1$s&quot; has to be between %2$s and %3$s.',
	'err_arg_key' => 'Unknown variable &quot;%1$s&quot;.',
	...
	# Messages
	'msg_update_var' => 'The value for &quot;%1$s&quot; has been set to %2$s.',
	'msg_update' => 'Module Configured',
	'msg_install' => 'The %1$s module has been re-installed. Triggering Database Updates..',
	'msg_wipe_confirm' => 'Do you really want to erase all databases used by the %1$s Module?',
	'msg_wipe' => 'The %1$s module has been wiped from disk. All data is lost and the DB is fresh.',
	'msg_installed' => 'You can now continue with the <a href="%1$s">%2$s Configuration</a>.',
	'msg_install_all' => 'All modules have been triggered with install / update request.<br/><a href="%1$s">Click here to return to the module overview</a>.',
	...
	'msg_pass_set' => 'The superuser password is now &quot;%1$s&quot; Do not forget it, since it can not get recovered or changed easily.',
	'msg_login_as' => 'You are now logged in as %1$s.',
	'msg_userpass_changed' => 'The Password for %1$s is now &quot;%2$s&quot;.',
	'msg_username_changed' => 'The User %1$s is now known as %2$s.',
	...
	'msg_module_enabled' => 'The %1$s Module has been enabled.',
	'msg_module_disabled' => 'The %1$s Module has been disabled.',
	'msg_new_path' => 'The Module-Path has been successfully changed.',
	'msg_new_name' => 'The Module has been renamed to %1$s. <b>Warning</b>: This will surely break all URLs!',
	'msg_defaults' => 'The ModuleVars have been reset to the default values.',
	'msg_removed_from_grp' => 'Removed User %1$s from Group %2$s.',
	'msg_added_to_grp' => 'Added User %1$s to Group %2$s.',
	...
	'btn_user_groups' => 'Edit %1$s`s groups',
	'btn_add_to_grp' => 'Add to group',
	'btn_add_group' => 'Add group',

	# Tooltips
	'tt_int' => 'Integer value between %1$s and %2$s.',
	'tt_text' => 'Text String with length %1$s to %2$s.',
	...
	'tt_time' => 'Duration between %1$s and %2$s.',
	'tt_float' => 'Floating Point Number between %1$s and %2$s.',

	#v2.01 (Add Group)
	'ft_add_group' => 'Add a group',
	'btn_add_group' => 'Add Group',
	'msg_group_added' => 'Group has been added.',
	'err_groupname' => 'The groupname is invalid. It has to be %1$s to %2$s characters long.',

	#v2.02 (refinish)
	'ft_install' => 'Install the %1$s module',
	'th_reinstall' => 'Drop Tables & ReInstall',
	'err_no_admin_sect' => 'This module has no admin section.',
	'err_module' => 'The module %1$s is unknown.',
	'pi_install' => 'The module %1$s has %2$s database tables:<br/>%3$s',
	...
	#v2.04 (drop wrapper)
	'ft_reinstall' => 'Reinstall module %1$s',
	...
	'msg_gpg_key' => 'Please use this as your fingerprint in config.php: %1$s',
