		...
		$back = array(
			...
			array(
				...
				array(
					...
					'att' => 'This modifier lowers the attack time of weapons.',
...
//					),
					...
					array(
						...
						'gmns' => "GM command. Usage: #gmns <player> on|off|<duration>. Set shout ban for player.",
						'gmq' => "GM command. Usage: #gmq <player> <quest> [amount|data] [<value>]. Get or set quest information.",
					...
					array(
						...
						'say' => "Player command. Usage: #say <#kw_id|the message>. If you meet other parties on street you can use #say to talk to them. Inside and outside locations this sends messages across the servers. In fight this sends messages to enemy party. See: #help chat_cmds.",
						...
						'whisper' => "Player command. Usage: #(w)hisper <player> <the message>. Send a message to another player. This works across networks. See: #help chat_cmds.",
