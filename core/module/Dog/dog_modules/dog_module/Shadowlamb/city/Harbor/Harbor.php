...
final class Harbor extends SR_Dungeon
{
	...
	public function getArriveText(SR_Player $player) { return 'You enter the Seattle Harbor. You see a lot of Depots and some bigger ships that are being loaded and unloaded.'; }
