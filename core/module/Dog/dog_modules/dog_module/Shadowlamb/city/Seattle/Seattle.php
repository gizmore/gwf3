...
{
	const TIME_TO_DELAWARE = 350;
	const TIME_TO_VEGAS = 1050;
	
	public function getImportNPCS() { return array('Redmond_Cyberpunk','Redmond_Ork','Redmond_Ueberpunk','Redmond_Burglar','Redmond_Prostitute', 'Seattle_Prostitute', 'Seattle_Stalker', 'Seattle_Mugger', Redmond_Snowman'); }
