...
{
	public function getItemDescription() { return 'Will scan a target for stats, attributes, skills, cyberware and spells. Additionally it allows #spy to locate a player.'; }
