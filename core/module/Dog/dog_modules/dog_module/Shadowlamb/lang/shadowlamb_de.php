...
'kills' => ', tötet %s mit %s', # player, damage
...
'range' => " {$b}Reichweite{$b}: %s.",
'atk_time' => " {$b}AttackTime{$b}: %ss.",
'worth' => " {$b}Wert{$b}: %s.",
'weight' => " {$b}Gewicht{$b}: %s.",
'forwards' => 'vorwärts',
'backwards' => 'rückwärts',
...
'fmt_asl' => "{$b}Alter{$b}:%s, %scm %s", # age, height, weight
'fmt_requires' => " {$b}Benötigt{$b}: %s.", # statted list
...
// 'last_action' => ' Letzte Aktion: %s %s. %s.', # last action, last target, last durcation
'pa_delete' => "{$b}wird gelöscht{$b}.",
'pa_talk' => "{$b}reden{$b} mit %s. %s übrig. Letzte Aktion: %s", # enemy party, duration, last action
'pa_fight' => "{$b}kämpfen{$b} gegen %s. Letzte Aktion: %s", # enemy party last action.
'pa_inside' => "{$b}innerhalb{$b} %s.", # location
'pa_outside1' => "{$b}ausserhalb{$b} of %s.", # location
'pa_outside2' => "irgendwo in %s.", # location
'pa_sleep' => "{$b}schlafen{$b} in %s.", # location
'pa_travel' => "{$b}reisen{$b} zu %s. %s übrig.", # location, duration
'pa_explore' => "{$b}erkunden{$b} %s. %s übrig.", # location, duration
'pa_goto' => "{$b}gehe{$b} zu %s. %s übrig.", # location, duration
'pa_hunt' => "{$b}jagen{$b} %s. %s übrig.", # location, duration
'pa_hijack' => "{$b}hijacking{$b} %s bei %s. %s übrig.", # playername, location, duration
...
# Stubs
'stub_found' => 'Du fandest %s. Es gibt noch keine Beschreibung.', # location
'stub_enter' => 'Du betrittst %s. Es gibt noch keinen Text.', # location
'stub_shop_slogan' => 'Willkommen in %s\'s Laden.', # player
'stub_found_bazar' => 'Du entdeckst den örtlichen Bazar, einen Ort wo du Items anbieten kannst oder erwerben.',
'stub_enter_bazar' => 'Du betrittst den Bazar. Es gibt %s Stände mit insgesamt %s Items.', # shopcount, itemcount
...
# Clan history
'ch_0' => '%s gründet den Klan/Gilde %s.', # player, clanname
'ch_1' => '%s will deinem Klan als Mitglied #%s beitreten.', # player, membernum
'ch_2' => '%s ist deinem Klan als Mitglied #%s beigetreten.', # player, membernum
'ch_3' => '%s hat deinen Klan verlassen er hat jetzt %s Mitglieder.', # player, amt
'ch_4' => "{$b}%s{$b}: \"%s\"", # player, message
'ch_5' => '%s legt %s in die KlanBank.', # player, nuyen
'ch_6' => '%s nimmt %s aus der KlanBank.', # player, nuyen
...
'hlp_bank' => "In a bank you can use #push and #pop to bank items, and #pushy and #popy to store nuyen. Use #view to list or search your banked items. Every transaction costs %s for you. You are currently using %s of %s item slots (stackables count for one, per type).",
...
'start_4' => "Benutz {$b}#c{$b} um alle verfügbaren Befehle zu sehen. Versuch {$b}#help{$b} um durch die Shadowlamb Hilfe zu blättern. Benutz #help <cmd> um die Hilfe zu einem Befehl zu erhalten.",
...
'1002' => 'Du brauchst mindestens Level %s zum schreien.', # level
'1004' => 'Du hast keine %s quests.', # section
...
#   5000-9999   = Messages #
############################
'5000' => '%s hat den IRC Server verlassen.', # username 
'5001' => 'Du wachst auf und hast ein köstliches Frühstück.',
'5002' => 'Du bist bereit aufzubrechen.',
'5003' => 'Das Team schreitet fort auf Level %s.', # level
'5004' => 'Deine Eigenschaften: %s.', # statlist
'5005' => '%s',
'5006' => 'Deine Skills: %s.', # statlist
'5007' => 'Bekannte Orte in %s: %s.', # cityname, places
'5008' => 'Dein Team hat %s: %s.', # nuyen sum, party sum list
...
'5025' => '%s hat %s verlassen.', # target, location
'5026' => '%s ist jetzt in deinem Team.', # target
'5027' => 'Du erkundest %s wieder, aber es scheint du kennst bereits jede Ecke.', # cityname
'5028' => 'Du erkundest %s wieder, aber du kannst nichts neues entdecken.', # cityname
...
'5040' => '%s ClanMembers Seite %s/%s: %s.', # membercount, page, npages, sumlist
'5041' => 'ClanHistory Seite %s/%s: %s.', # page, npages, weird msglist
'5042' => 'Cmds: %s.',
...
'5079' => 'Your mount Seite %s/%s: %s.', # page, pages, itemlist
...
'5088' => '%s', # own bounty
'5089' => '%s', # other bounty
'5090' => '%s bewegt sich %s meter %s und hat jetzt die Position %s meters%s', # player, fw/bw, metres, busy (OWN)
'5091' => '%s bewegt sich %s meter %s und hat jetzt die Position %s meters%s', # player, fw/bw, metres, busy (ENEMY)
'5092' => 'Das gegnerische Team sagt "bye".',
'5093' => 'You continue %s', # action
'5094' => '%s dankt dir und verlässt das Team.', # player
'5095' => "Du {$b}ENCOUNTER{$b} %s.",
...
'5123' => 'Entfernungen: %s.', # sumlist
'5124' => 'Entfernungen: %s.', # sumlist
'5125' => 'Du kriegst eine Belohnung in Höhe von %s für das töten des Feindes.', # nuyen
...
'5135' => '%s verlässt das Team.', # player
'5136' => '%s tritt dem Team bei.', # player
'5137' => '%s wurde aus dem Team geworfen.', # player
'5138' => '%s ist der neue Team-Leiter.', # player
...
'5143' => 'Du bezahlst %s nuyen.', # nuyen
...
'5182' => "Das Team geht schlafen. Du gehst in dein {$b}eigenes{$b} Schlafzimmer.",
...
'5192' => 'Du versuchst %s zu stehlen...', # itemname
...
'5247' => 'Active players, Seite %s of %s: %s.', # page, nPages, rawlist
'5248' => 'Active parties, Seite %s of %s: %s.', # page, nPages, rawlist
'5249' => 'Nachricht des Tages: %s', # file content
'5250' => 'You know a new %s: %s.', # knowledge, what, field
'5251' => "Du hast nun {$b}%s(+%s) karma{$b}. Mit Karma kannst du #%s 'pen.", # karma, karmagain
'5252' => 'Du respawnst bei %s.', # location
'5253' => 'Du verlierst %s XP!', # xp
'5254' => 'Du verlierst %s Nuyen!', # nuyen
...
'5260' => 'Du erhälst +%s MP (%s/%s).', # From orcas effect
'5261' => 'Du erhälst +%s HP (%s/%s).', # From elpehants effect
'5262' => 'Mögliche Operation: %s.', # Some prices fmt_sumlist.
'5263' => 'Du zahlst %s und tauschst dein %s zu einem %s. Du verlierst %s Essenz und erhälst %s karma zurück.', # price, field, value, essence, karma
'5264' => 'Du überträgst %s auf dein Bankkonte von einem anderen Konto.',
'5265' => 'Fehlende Quests in %s: %s.', # city, list
'5266' => 'Dein a/s/l wurde gesetzt auf %s.', # asl_list
...
'5273' => "Du erhälst {$b}%s{$b}.",
'5274' => "Du erhälst {$b}%s{$b} von %s.",
...
'5288' => 'It would cost %s to remove your %s. Type #%s %s to confirm.', # nuyen, piercing, unpierce, iamsure
