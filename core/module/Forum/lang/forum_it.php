...
$lang = array(
		...
		'err_no_subscr' => 'Non può sottoscriversi manualmente a questo thread. <a href="%s">Clicca qui per tornare al thread</a>.',
		'err_subscr' => 'Si è verificato un errore. <a href="%s">Clicca qui per tornare al thread</a>.',
		'err_no_unsubscr' => 'Non può rimuovere la sottoscrizione a questo thread. <a href="%s">Clicca qui per tornare al thread</a>.',
		'err_unsubscr' => 'Si è verificato un errore. <a href="%s">Clicca qui per tornare al thread</a>.',
		...
		'err_better_edit' => 'In caso di errore, la preghiamo di modificare il post errato e di evitare di crearne un altro. Tramite &quot;Mark-Unread&quot; può nuovamente impostare il post come non letto.<br/><a href="%s">Clicca qui per tornare al thread</a>.',

		# Messages
		'msg_posted' => 'Il messaggio è stato pubblicato.<br/><a href="%s">Clicca qui per vedere il messaggio</a>.',
		'msg_posted_mod' => 'Il messaggio è stato pubblicato, ma sarà controllato prima di essere visualizzato.<br/><a href="%s">Clicca qui per tornare alla sezione</a>.',
		'msg_post_edited' => 'Il post è stato modificato.<br/><a href="%s">Clicca qui per tornare al post</a>.',
		'msg_edited_board' => 'La sezione è stata modificata.<br/><a href="%s">Clicca qui per tornare alla sezione</a>.',
		'msg_board_added' => 'La nuova sezione è stata aggiunta con successo. <a href="%s">Clicca qui per andare alla sezione</a>.',
		...
		'msg_subscribed' => 'Ha sottoscritto il thread e riceverà notifiche tramite E-Mail ad ogni nuovo post.<br/><a href="%s">Clicca qui per tornare al thread</a>.',
		...
		'msg_thanked' => 'I suoi ringraziamenti sono stati salvati.<br/><a href="%s">Clicca qui per tornare al post</a>.',
		...
		'th_guests' => 'Autorizza post ad utenti non registrati',
		...
		# New Post EMail
		'submail_subj' => GWF_SITENAME.': Nuovo Post: "%s" by %s in %s',
		'submail_body' =>
		'Caro %s'.PHP_EOL.
		PHP_EOL.
		...
		'msg_attach_added' => 'L\'allegato è stato caricato. <a href="%s">Clicca qui per tornare al post.</a>',
		'msg_attach_deleted' => 'L\'allegato è stato cancellato. <a href="%s">Clicca qui per tornare al post.</a>',
		'msg_attach_edited' => 'L\'allegato è stato modificato. <a href="%s">Clicca qui per tornare al post.</a>',
		...
		'msg_subscrboard' => 'E\' sottoscritto a questa sezione e riceverà E-Mail di notifica.<br/><a href="%s">Clicca qui per tornare alla sezione</a>.',
		'msg_unsubscrboard' => 'Ha cancellato la sottoscrizione a questa sezione e non riceverà più E-Mail.<br/><a href="%s">Clicca qui per tornare alla panoramica delle sottoscrizioni</a>.',
