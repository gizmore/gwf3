...
$lang = array(
	...
	'err_reply_perm' => 'Nie masz odpowiednich przywilejów, aby odpowiadać w tym temacie. <a href="%s">Kliknij tutaj aby powrócić do tematu</a>.',
	...
	'err_msg_long' => 'Twoja wiadomość jest zbyt długa. Wprowadź maksymalnie %s znaków.',
	'err_msg_short' => 'Wpisz wiadomość!',
	'err_descr_long' => 'Twój opis jest zbyt długi. Wpisz maksymalnie %s znaków.',
	'err_descr_short' => 'Nie wpisałeś opisu.',
	'err_title_long' => 'Tytuł jest za długi. Wpisz maksymalnie %s znaków.',
	'err_title_short' => 'Nie wpisałeś tytułu.',
	'err_sig_long' => 'Twój podpis jest za długi. Wpisz maksymalnie %s znaków.',
	...
	'err_no_subscr' => 'Nie możesz dokonać subskrypcji w tym wątku. <a href="%s">Kliknij tutaj, aby powrócić do tematu</a>.',
	'err_subscr' => 'Wystąpił błąd. <a href="%s">Kliknij tutaj, aby powrócić do temutu</a>.',
	'err_no_unsubscr' => 'Nie możesz zrezygnować z subskrypcji. <a href="%s">Kliknij tutaj, aby powrócić do tematu</a>.',
	'err_unsubscr' => 'Wystąpił błąd. <a href="%s">Kliknij tutaj, aby powrócić do temutu</a>.',
	...
	'err_better_edit' => 'Nie pisz dwóch wiadomości pod rząd, skorzystaj z edycji. Możesz używać flag &quot;Mark-Unread&quot; to oznaczania istotnych zmian.<br/><a href="%s">Kliknij tutaj, aby powrócić do wątku</a>.',

	# Messages
	'msg_posted' => 'Twoja wiadomość została wysłana.<br/><a href="%s">Kliknij tutaj, aby zobaczyć wiadomość</a>.',
	'msg_posted_mod' => 'Twoja wiadomość została wysłana, ale musi poczekać na akceptację.<br/><a href="%s">Kliknij tutaj, aby powrócić do forum</a>.',
	'msg_post_edited' => 'Dokonałeś edycji wiadomości.<br/><a href="%s">Kliknij, aby powrócić do wątku</a>.',
	'msg_edited_board' => 'Forum zostało zedytowane.<br/><a href="%s">Kliknij, aby powrócić na forum</a>.',
	'msg_board_added' => 'Nowe forum zostało pomyślnie dodane. <a href="%s">Kliknij, aby powrócić</a>.',
	...
	'msg_subscribed' => 'Dokonałeś subskrypcji tego wątku. Na Twój adres e-mail zostaną wysłane najnowsze wiadomości<br/><a href="%s">Kliknij, aby powrócic do wątku</a>.',
	'msg_unsubscribed' => 'Zrezygnowałeś z subskrypcji wątku i nie będziesz już otrzymywał e-maili z tego wątku.<br/><a href="%s">Kliknij, aby powrócić do wątku</a>.',
	'msg_unsub_all' => 'Wypisałeś się ze subskrypcji we wszystkich wątkach.',
	'msg_thanked_ajax' => 'Twoje podziękowania zostały dodane.',
	'msg_thanked' => 'Twoje podziękowania zostały dodane.<br/><a href="%s">Kliknij tutaj, aby powrócić do wiadomości</a>.',
	'msg_thread_moved' => 'Wątek %s został przesunięty do %s.',
	'msg_voted' => 'Dziękujemy za oddanie głosu.',
	'msg_marked_read' => '%s wątków zostało oznaczonych jako przeczytane.',
...
//	'pt_board' => '%s ['.GWF_SITENAME.']',
	...
	'at_mailto' => 'Wyślij maila do %s',
	'last_edit_by' => 'Ostatnio edytowany przez %s - %s',
...
//	'th_unread_again' => '',
	...
	'watchers' => '%s użytkowników ogląda obecnie ten watek.',
	'views' => 'Ten temat został obejrzany %s razy.',
	...
	'modmail_body' =>
		...
		PHP_EOL.
		PHP_EOL.
		'Post zostanie automatycznie pokazany po upływie %s'.PHP_EOL.
		PHP_EOL.
		'Pozdrawiamy'.PHP_EOL.
		'Zespół '.GWF_SITENAME.PHP_EOL,

	# New Post EMail
	'submail_subj' => GWF_SITENAME.': Nowa wiadomość: "%s" by %s in %s',
	'submail_body' => 
		'Szanowny użytkowniku %s'.PHP_EOL.
		PHP_EOL.
		'Mamy %s nowych wiadomości na '.GWF_SITENAME.' forach'.PHP_EOL.
		PHP_EOL.
		'Forum: %s'.PHP_EOL.
		'Wątek: %s'.PHP_EOL.
		PHP_EOL.
	...
	# v2.01 (last seen)
	'last_seen' => 'Ostatnio widziany: %s',

	# v2.02 (Mark all read)
	'btn_mark_read' => 'Zaznacz wszystkie jako przeczytane',
	'msg_mark_aread' => 'Zaznacz %s wątki jako przeczytane.',
	...
	'pt_history' => 'Historia forum - Strona %s / %s',
