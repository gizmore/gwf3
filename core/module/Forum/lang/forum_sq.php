...
$lang = array(
	...
	'err_reply_perm' => 'Ju nuk mund të përgjigjeni në këtë temë. <a href="%s">Kliko këtu për tu kthyer në temë</a>.',
	'err_no_thread_allowed' => 'Nuk ka tema ne kete bord janë të lejuara.',
	'err_no_guest_post' => 'Mysafir nuk mund të shkruaj në këtë bord.',
	'err_msg_long' => 'Mesazhi juaj është shumë i gjatë. lejohet një maksimum %s Shenjë.',
	'err_msg_short' => 'Ju keni harruar mesazhin.',
	'err_descr_long' => 'Përshkrimi juaj është shumë i gjatë. lejohet një maksimum %s Shenjë.',
	'err_descr_short' => 'Ju harruar Përshkrimi.',
	'err_title_long' => 'Titulli është shumë i gjatë. Lejohet një maksimum%s Shenjë.',
	'err_title_short' => 'Keni harruar titullin.',
	'err_sig_long' => 'Firma juaj është shumë i gjatë. Lejohet një maksimum %s Shenjë.',
	...
	'err_no_subscr' => 'Ju mund të regjistroheni në këtë temë nuk është shtesë. <a href="%s">Kliko këtu për tu kthyer në temë</a>.',
	'err_subscr' => 'Një gabim ka ndodhur. <a href="%s">Kliko këtu për tu kthyer në temë</a>.',
	'err_no_unsubscr' => 'Ju nuk mund të largohet nga Abbonenemt për këtë çështje. <a href="%s">Kliko këtu për tu kthyer në temë</a>.',
	'err_unsubscr' => 'Një gabim ka ndodhur. <a href="%s">Kliko këtu për tu kthyer në temë</a>.',
	...
	'err_better_edit' => 'Ju lutemi redaktoni mesazhin tuaj te fundit. Nuk është e mundur të dërgojë dy herë në një mesazh rresht. Ju mund të &quot;Shëno si të lexuar&quot;, në qoftë se ata dëshirojnë të bëjnë ndryshime serioze në mesazhin e tyre.<br/><a href="%s">Kliko këtu për tu kthyer në temë</a>.',

	# Messages
	'msg_posted' => 'Mesazhi juaj u dërgua.<br/><a href="%s">Kliko këtu për të parë mesazhin tuaj</a>.',
	'msg_posted_mod' => 'Mesazhi juaj u dërgua. Ai duhet, megjithatë, kontrolluar nga një moderator para ekranit.<br/><a href="%s">Kliko këtu për të shkuar mbrapa në Bord të</a>.',
	'msg_post_edited' => 'Mesazhi i juaj është redaktuar.<br/><a href="%s">Kliko këtu për të parë mesazhin tuaj</a>.',
	'msg_edited_board' => 'Bordi është redaktuar.<br/><a href="%s">Kliko këtu për tu kthyer në Bordin</a>.',
	'msg_board_added' => 'Një bord i ri u shtua. <a href="%s">Kliko këtu për tu kthyer në forum</a>.',
	...
	'msg_subscribed' => 'Ju jeni i regjistruar në këtë temë dhe tani do të merrni email kur një mesazh të ri.<br/><a href="%s">Kliko këtu për tu kthyer në temë</a>.',
	'msg_unsubscribed' => 'Ata kanë denoncuar Abbonement për këtë çështje dhe nuk do të marrin ndonjë email më shumë për këtë temë.<br/><a href="%s">Kliko këtu për tu kthyer në temë</a>.',
	...
	'msg_thanked' => 'Faliminderi juaj ishte regjistruar në bazën e të dhënave.<br/><a href="%s">Klicken sie hier um zur Nachricht zurückzukehren</a>.',
	'msg_thread_moved' => 'Tema %s ishte për të %s lëvizur.',
	'msg_voted' => 'Faleminderit për votën tuaj.',
	'msg_marked_read' => 'Ka qenë %s Temat shënuar si të lexuar.',
...
//	'pt_board' => '%s ['.GWF_SITENAME.']',
	...
	'at_mailto' => 'Një email dërguar per %s',
	'last_edit_by' => 'Fundit modifikuar nga %s - %s',
...
//	'th_unread_again' => '',
	...
	'watchers' => '%s Njerëzit shikojnë këtë çështje tani.',
	'views' => 'Kjo temë është %s shikime.',
	...
	'modmail_body' =>
		...
		PHP_EOL.
		PHP_EOL.
		'Mesazhi është automatikisht mas %s përshtatshme.'.PHP_EOL.
		PHP_EOL.
	...
	'submail_body' => 
		...
		PHP_EOL.
		'Ka %s mesazh te rea '.GWF_SITENAME.' Forum'.PHP_EOL.
		PHP_EOL.
		'Bordi: %s'.PHP_EOL.
		'Temë: %s'.PHP_EOL.
		PHP_EOL.
	...
	# v2.01 (last seen)
	'last_seen' => 'E fundit shihet në: %s',

	# v2.02 (Mark all read)
	'btn_mark_read' => 'Mark të gjitha të lexuar',
	'msg_mark_aread' => '%s Çështjet janë shënuar si të lexuar.',
	...
	'pt_history' => 'tema të vjetra në këtë forum - Faqe %s / %s',
	...
	'msg_attach_added' => 'Shtojcën juaj është ngarkuar. <a href="%s">Kliko këtu për tu kthyer në zurückzugelangen tyre mesazh.</a>',
	'msg_attach_deleted' => 'Shtojcën juaj u fshi. <a href="%s">Kliko këtu për tu kthyer në zurückzugelangen tyre mesazh.</a>',
	'msg_attach_edited' => 'Shtojcën juaj është përpunuar. <a href="%s">Kliko këtu për tu kthyer në zurückzugelangen tyre mesazh.</a>',
	...
	# v2.10 subscribers
	'subscribers' => '%s janë regjistruar në këtë temë dhe të marrin mesazhe email me një mesazh të ri.',
