...
$lang = array(
	...
	'err_gbm_username' => 'Teie kasutajanimi on vigane. See peab olema %s kuni %s tähte pikk.',
	'err_gbm_message' => 'Teie sõnum on vigane. See peab olema %s kuni %s tähte pikk.',
	'err_gbm_url' => 'Teie veebisait ei ole kättesaadav või on see vigane.',
	'err_gbm_email' => 'Teie e-mail on vigane.',
	'err_gb_title' => 'Teie pealkiri on vigane. See peab olema %s kuni %s tähte pikk.',
	'err_gb_descr' => 'Teie kirjeldus on vigane. See peab olema %s kuni %s tähte pikk.',
	...
	'mailb_signed' => 
		...
		PHP_EOL.
		'%s külalisteraamat sai märgistatud %s poolt(%s)'.PHP_EOL.
		'Sõnum:'.PHP_EOL.
		'%s'.PHP_EOL.
		PHP_EOL.
