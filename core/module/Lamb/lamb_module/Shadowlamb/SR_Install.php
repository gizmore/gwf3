...
{
	public static $TABLES = array('SR_Item', 'SR_Party', 'SR_Player', 'SR_Quest', 'SR_Stats', 'SR_PlayerStats', 'SR_PlayerVar', 'SR_Bounty', 'SR_BountyStats', 'SR_BountyHistory', 'SR_KillProtect', 'SR_BazarItem', 'SR_BazarShop', 'SR_BazarHistory');
