...
//					),
					...
					array(
						...
						'quests' => 'Player command. Usage: #(qu)ests [<open|done|deny|fail|abort|stats|cstats|searchterm|id>] [<page>]. Shows info about your quests. To get quests you need to talk to the npc. Most often, the trigger is #talk shadowrun and #talk yes to get them.',
