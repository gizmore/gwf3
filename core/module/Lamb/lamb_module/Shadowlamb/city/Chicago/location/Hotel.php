...
final class Chicago_Hotel extends SR_Hotel
{
	...
	public function getFoundText(SR_Player $player) { return 'You find a Hotel. A sign reads: "Rooms, 150 Nuyen a day".'; }
	public function getEnterText(SR_Player $player) { return 'You enter the Hotel. You see the Hotelier and walk to the counter. You also see a suspicious woman in a loungy corner.'; }
