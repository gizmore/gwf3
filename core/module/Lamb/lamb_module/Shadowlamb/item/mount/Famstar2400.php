...
{
	public function getItemDescription() { return 'An old and used minivan for the family prodced by Toyota, but it\'s in good shape. It has 2400ccm and 80kg storage with a maxspeed of 155kp/h.'; }
