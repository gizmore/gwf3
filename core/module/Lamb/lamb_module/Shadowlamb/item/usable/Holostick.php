...
class Item_Holostick extends Item_Credstick
{
	...
	public function getItemDescription() { return sprintf("You can access your bank money and items with a Holostick. Try #use Holostick [<pushy|popy|pushi|popi>] [<nuyen|item>] [<item_amount>]. Each money transaction cost %s. The item transaction cost varies per item weight and value. You cannot popi items with a Holstick.", Shadowfunc::displayNuyen($this->getTransactionCost())); }
