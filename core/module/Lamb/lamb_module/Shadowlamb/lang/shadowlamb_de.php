...
'5012' => 'Dein asl: %s. Benutz #asl [<alter|bmi|grösse>] für Team Beträge.',
...
'5251' => "Du hast nun {$b}%s(+%s) karma{$b}. Mit Karma kannst du #lvlup 'pen.", # karma, karmagain
'5252' => 'Du respawnst bei %s.', # location
'5253' => 'Du verlierst %s XP!', # xp
'5254' => 'Du verlierst %s Nuyen!', # nuyen
'5255' => 'Du verlierst %s von deinen %s.',
'5256' => 'Du hast #running_mode gespielt und wurdest von einem NPC oder anderem #rm Spieler getötet. Benutz #reset um von vorne zu beginnen.',
