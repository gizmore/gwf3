...
'eta' => 'ETA: %s.', # duration
'hits1' => ', golpea %s con %s daño', # player, damage
'hits2' => ', golpea %s con %s(%s/%s)HP queda', # player, damage, hp left, max hp
...
'last_action' => ' Ultima accion: %s %s. %s.', # last action, last target, last durcation
...
'pa_inside' => "{$b}dentro{$b} %s.", # location
...
'hlp_exit' => 'Puedes volver a este lugar para #leave el edificio.',
...
'1010' => 'No existen búsquedas aquí.',
...
########################
# Generic
'10000' => '%s usa un nivel de %s %s poción sobre %s.',
'10001' => '%s lanza un nivel %s %s sobre %s.',
'10002' => '%s usa un nivel %s %s poción sobre %s.',
'10003' => '%s lanza un nivel %s %s sobre %s.',
# Berzerk
'10010' => '%s usa un nivel de %s %s poción sobre %s, +%s min_dmg / +%s max_dmg para %s.',
'10011' => '%s lanza un nivel %s %s sobre %s, +%s min_dmg / +%s max_dmg para %s.',
'10012' => '%s usa un nivel de %s %s poción sobre %s.',
'10013' => '%s lanza un nivel %s %s sobre %s.',
# Blow
'10020' => '%s usa un nivel de %s %s poción sobre %s que quedó impresionado %s y ahora esta en posición %s.',
'10021' => '%s lanza un nivel %s %s sobre %s que quedó impresionado %s y ahora esta en posición %s.',
'10022' => '%s usa un nivel de %s %s poción sobre %s que quedó impresionado %s y ahora esta en posición %s.',
'10023' => '%s lanza un nivel %s %s sobre %s que quedó impresionado %s y ahora esta en posición %s.',
# Chameleon
'10030' => '%s usa un nivel de %s %s poción sobre %s, +%s carisma para %s.',
'10031' => '%s lanza un nivel %s %s sobre %s, +%s carisma para %s.',
'10032' => '%s usa un nivel de %s %s poción sobre %s.',
'10033' => '%s lanza un nivel %s %s sobre %s.',
# Firebolt
'10040' => '%s usa un nivel del %s %s poción sobre %s y causa %s daño.',
'10041' => '%s lanza un nivel %s %s sobre %s y causa %s daño.',
'10042' => '%s usa un nivel de %s %s poción sobre %s y causa %s daño, %s/%s HP queda.',
'10043' => '%s lanza un nivel %s %s sobre %s y causa %s daño, %s/%s HP queda.',
# Freeze
'10050' => '%s usa un nivel de %s %s poción sobre %s. %s segundos congelado con un poder de %01f.',
'10051' => '%s lanza un nivel %s %s sobre %s. %s segundos congelado con un poder de %01f.',
'10052' => '%s usa un nivel de %s %s pocion sobre %s. %s segundos congelado con un poder de %01f.',
'10053' => '%s lanza un nivel %s %s sobre %s. %s segundos congelado con un poder de %01f.',
# Goliath
'10060' => '%s usa un nivel de %s %s poción sobre %s, +%s fuerza para %s.',
'10061' => '%s lanza un nivel %s %s sobre %s, +%s fuerza para %s.',
'10062' => '%s usa un nivel de %s %s poción sobre %s.',
'10063' => '%s lanza un nivel %s %s sobre %s.',
# Hawkeye
'10070' => '%s usa un nivel de %s %s poción sobre %s, +%s armas de fuego para %s.',
'10071' => '%s lanza un nivel %s %s sobre %s, +%s armas de fuego para %s.',
'10072' => '%s usa un nivel de %s %s poción sobre %s.',
'10073' => '%s lanza un nivel %s %s sobre %s.',
# Hummingbird
'10080' => '%s usa un nivel de %s %s poción sobre %s, +%s rápidez para %s.',
'10081' => '%s lanza un nivel %s %s sobre %s, +%s rápidez para %s.',
'10082' => '%s usa un nivel de %s %s poción sobre %s.',
'10083' => '%s lanza un nivel %s %s sobre %s.',
# Magicarp
'10090' => '%s usa un nivel de %s %s poción sobre %s y pierden %s MP.',
'10091' => '%s lanza un nivel %s %s sobre %s, +%s y pierden %s MP.',
'10092' => '%s usa un nivel de %s %s pocion sobre %s y pierden %s MP.',
'10093' => '%s lanza un nivel %s %s sobre %s y pierden %s MP.',
# Turtle
'10100' => '%s usa un nivel de %s %s pocion sobre %s, +%s marm/farm for %s.',
'10101' => '%s lanza un nivel %s %s sobre %s, +%s marm/farm for %s.',
'10102' => '%s usa un nivel de %s %s pocion sobre %s.',
'10103' => '%s lanza un nivel %s %s sobre %s.',
# Heal
'10110' => '%s usa un nivel de %s %s poción sobre %s, %s.',
'10111' => '%s lanza un nivel de %s %s sobre %s, %s.',
'10112' => '%s usa un nivel de %s %s poción sobre %s.',
'10113' => '%s lanza un nivel de %s %s sobre %s.',
...
'5009' => 'Estadísticas de búsquedas por ciudad: %s.', # questlist
'5010' => 'Estadísticas de búsqueda: %d abierto, %d acabado, %d rechazado, %d fallido, %d desconocido de un total de %d.',
...
'5094' => '%s agradece y deja el grupo.', # player
'5095' => 'Tu encuentras %s.',
'5096' => 'Tu conoces %s.%s%s',
'5097' => '%s se mueve %.01f metros hacia %s y ahora esta en posición %.01f metros. %ds ocupado.',
'5098' => '%s se mueve %.01f metros hacia %s y ahora está en posición %.01f metros.',
'5105' => 'Tu ganas %s y %s XP.', # nuyen, XP
'5110' => 'Estas a punto de dejar %d %s. Reteclea para confirmar.', # amt itemname
...
'5185' => 'Tu buscas el %s...',
'5186' => 'Tu buscas el %s pero no encuentras nada.',
