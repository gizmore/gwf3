...
'10111' => '%1$s casts a level %2$s %3$s on %4$s, %5$s, %8$s %9$s quitté.',
...
'10121' => '%1$s casts a level %2$s %3$s on %4$s. +%5$sHP for %6$s seconds, %8$s %9$s quitté.',
...
'5010' => 'Stats quête: %s open, %s accomplished, %s rejected, %s failed, %s unknown from a total of %s.',
...
'5036' => 'Votre personnage a été puni %s bad_karma.', # bad karma
...
'5097' => '%s se déplace %s de quelques mètres en direction de %s et est maintenant situé à %s mètres. %ss occupé.',
...
'5122' => 'Votre distance de combat par défaut a été fixé à %s meters.',
...
'5188' => 'Vous banque', # Store item list fmt_sumlist
