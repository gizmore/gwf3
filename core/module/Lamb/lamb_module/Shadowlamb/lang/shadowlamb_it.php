...
'pa_sleep' => "{$b}sleeping{$b} in %s.", # location
'pa_travel' => "{$b}travelling{$b} verso %s. %s rimasti.", # location, duration
'pa_explore' => "{$b}exploring{$b} %s. %s rimasti.", # location, duration
'pa_goto' => "{$b}going{$b} a %s. %s rimasti.", # location, duration
'pa_hunt' => "{$b}hunting{$b} %s. %s rimasti.", # location, duration
'pa_hijack' => "{$b}hijacking{$b} %s a %s. %s rimasti.", # playername, location, duration
...
# Bounty
'meet_bounty' => " C\'è una {$b}bounty{$b} su %s.", # sumlist
'no_bounty' => 'Questo giocatore non ha nessuna taglia.',
'total_bounty' => "C\'è una {$b}bounty of %s{$b} per %s: %s.", # total, player, details
...
'hlp_clan_enter' => "Unisciti al clan con {$c}abandon, {$c}request e {$c}accept. Crea un clan con {$c}create. Compra dei miglioramenti ed un motto con {$c}manage. Imposta le opzioni con {$c}toggle. Accedi alla banca oggetti del clan con {$c}push, {$c}pop e {$c}view, e a quella degli oggetti con {$c}pushy e {$c}popy.",
'hlp_bank' => "In una banca puoi usare {$c}pushi e {$c}popi per lasciare e prendere oggetti, e {$c}pushy and {$c}popy per versare e ritirare nuyen. Usa {$c}viewi per visualizzare o cercare i tuoi oggetti nella banca. Ogni transazione ti costa %s.",
'hlp_bazar' => "Nel bazaar puoi vendere i tuoi oggetti. Qui puoi usare #push, #pop, #view, #search, #buy, #bestbuy, #buyslot, #slogan e #price.",
'hlp_elevator' => 'Negli ascensori puoi usare #up, #down e #floor.',
'hlp_exit' => 'Puoi ritornare in questa località per #leave la costruzione.',
'hlp_hotel' => 'Puoi pagare %s per #sleep qui e recuperare gli HP/MP del tuo gruppo.',
'hlp_hack' => ' Puoi usare un Cyberdeck per hackare in un computer.',
'hlp_search' => ' Puoi usare #search qui per cercare oggetti nella stanza.',
...
'start_3' => "Controlli il tuo {$b}{$c}inventory{$b} e trovi una penna di 'Renraku Inc.'. Lasci la tua stanza e ti dirigi al bancone. Usa {$b}{$c}talk{$b} per parlare con il portiere.",
'start_4' => "Usa {$b}{$c}c{$b} per vedere i comandi disponibili. Controlla {$b}{$c}help{$b} per visualizzare i file d\'aiuto di Shadowlamb. Usa {$c}help <comando> per vedere il file d\'aiuto per un comando.",
...
'1111' => 'Tutti gli slot del tuo bazaar sono in uso. Prova #pop o #buyslot.',
...
'1126' => 'Il clan ha raggiunto il limite dei membri, ovvero %d. Puoi comprare nuovi slot per i membri tramite la funzione #manage.',
...
'1153' => 'La destinazione è sconosciuto. Controlla la lista delle destinazioni con #travel.',
'1154' => 'Non puoi permetterti %d biglietti per %s.',
'1155' => 'Questo equipaggiamento non ha un uso particolare. Puoi equipaggiarlo con #equip.',
...
'1164' => 'Utilizza "#mount clean" prima di cambiare mezzo.',
...
'1171' => 'Il tuo personaggio è già stato creato. Puoi usare #reset per ripartire da capo.',
...
'5012' => 'Il tuo asl: %s. Usa #asl [<age|bmi|height>] per la somma su tutto il gruppo.',
...
'5023' => 'La tua richiesta di join è stat inviato al leader del clan.',
'5024' => 'Il bersaglio per il dirottamento (%s) se ne è andato.', # target
...
'5034' => "Hai reclamato una {$b}bounty{$b}: %s.", # nuyen
...
'5129' => '%s', # Mount page
'5130' => 'Mezzi di trasporto da dirottare: %s.', # sumlist
...
'5152' => "%s vende un %3\$s, da un totale di %2\$d, per {$b}%4\$s{$b}. Digita {$b}#buy %1\$s %3\$s{$b} per comprare.", # player, itemcount, itemname, nuyen, examinestring
...
'5157' => 'Attualmente hai %d di %d slot per il tuo bazaar utilizzati. Un altro slot ti costerebbe %s. Digita "#buyslot yesplease" per confermare.',
...
'5169' => 'Hai pagato la commissione di %s ed impostato unnuovo slogan per il tuo clan.',
...
'5182' => "Il gruppo va a dormire. Ti dirigi alla {$b}own{$b} stanza.",
...
'5219' => "%s sta cercando di {$b}crack the LOCK{$b} sul tuo %s!",
...
'5245' => 'Il tuo personaggio è stato cancellato. Puoi utilizzare "#start" nuovamente.',
'5246' => 'Questo cancellerà completamente il tuo personaggio. Digita "#reset i_am_sure" per confermare.',
