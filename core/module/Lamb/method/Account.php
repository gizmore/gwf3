...
final class Lamb_Account extends GWF_Method
{
	...
	{
		$data = array(
			'player_name' => array(GWF_Form::STRING, '', $this->module->lang('th_player_name'), $this->module->lang('tt_player_name')),
			'player_pass' => array(GWF_Form::PASSWORD, '', $this->module->lang('th_player_pass'), $this->module->lang('tt_player_pass')),
			'link_player' => array(GWF_Form::SUBMIT, $this->module->lang('btn_link_account')),
		);
	...
	private function formCreate()
	{
		...
		$data = array(
			'create_player_name' => array(GWF_Form::STRING, $default_name, $this->module->lang('th_player_name'), $this->module->lang('tt_player_name')),
			'create_player_pass' => array(GWF_Form::PASSWORD, '', $this->module->lang('th_player_pass'), $this->module->lang('tt_player_pass')),
			'create_player' => array(GWF_Form::SUBMIT, $this->module->lang('btn_create_account')),
		);
		return new GWF_Form($this, $data);
	}
	...
	private function onLink()
	{
		...
		return $this->module->message('msg_char_linked');
	}
	...
	private function onCreate()
	{
		...
		return $this->module->message('msg_char_created');
	}
}
?>
