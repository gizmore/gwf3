...
final class GWF_LangFile extends GDO
{
	...
	public function getColumnDefines()
	{
		return array(
			...
			'lf_editor' => array(self::OBJECT, self::NOT_NULL, array('GWF_User', 'lf_editor')),
	...
	public static function getByPath($fullpath, $force=true)
	{
		...
		if (false === ($file = self::table(__CLASS__)->selectFirst("lf_name='$ename'", 'lf_rev DESC'))) {
			if ($force === true) {
				return self::createByPath($fullpath);
			}
			else {
				return false;
			}
