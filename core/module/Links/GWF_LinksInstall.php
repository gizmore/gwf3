...
final class GWF_LinksInstall
{
	public static function onInstall(Module_Links $module, $dropTable)
	{
		return GWF_ModuleLoader::installVars($module, array(
			'link_long_descr' => array(false, 'bool'),
			'link_guests' => array(true, 'bool'),
			'link_guests_mod' => array(true, 'bool'),
			'link_guests_votes' => array(false, 'bool'),
			'link_guests_captcha' => array(true, 'bool'),
			...
			'show_permitted' => array(true, 'bool'),
