...
//	'pi_links' => '',
	...
	'info_newlinks' => 'Sulle on %s uut linki.',
	'info_search_exceed' => 'Sinu otsing ületab tulemuste limiidi %s.',
	...
	'mt_linksec' => GWF_SITENAME.', Link, List, Lingid %s kohta',
	'md_linksec' => '%s linke '.GWF_SITENAME.'.',

	# Errors
	'err_gid' => 'Kasutajagrupp on vigane.',
	'err_score' => 'Vigane väärtus skooril.',
	'err_no_tag' => 'Palun täpsusta vähemalt ühte märksõna.',
	'err_tag' => 'Märksõna %s on vigane ja eemaldatud. Märksõna peab olema %s - %s baiti.',
	'err_url' => 'URL on vigane.',
	'err_url_dup' => 'URL on juba olemas.',
	'err_url_down' => 'URLi pole võimalik avada.',
	'err_url_long' => 'Sinu URL on liiga pikk. Maksimum  %s baiti.',
	'err_descr1_short' => 'Sinu kirjeldus on liiga lühike. Miinimum %s baiti.',
	'err_descr1_long' => 'Sinu kirjeldus on liiga pikk. Maksimum %s baiti.',
	'err_descr2_short' => 'Sinu detailne kirjeldus on liiga lühike. Miinimum %s baiti.',
	'err_descr2_long' => 'Sinu detailne kirjeldus on liiga pikk. Maksimum %s baiti.',
	...
	'err_score_tag' => 'Sinu kasutajatase(%s) ei ole piisavalt kõrge uue märksõna lisamiseks. Nõutud tase: %s.',
	'err_score_link' => 'Sinu kasutajatase(%s) ei ole piisavalt kõrge uue lingi lisamiseks. Nõutud tase: %s.',
	'err_approved' => 'Link oli juba heakskiidetud. Palun kasuta staff sektsiooni, et midagi muuta.',
	'err_token' => 'Vigane valik.',

	# Messages
//	'msg_redirecting' => 'Ümbersuunan sind %s.',
	...
	'mail_body' =>
		...
		PHP_EOL.
		'Kirjeldus: %s'.PHP_EOL.
		'Detailne Kirjeldus.: %s'.PHP_EOL.
		'HREF / URL : %s'.PHP_EOL.
		PHP_EOL.
		'Sa võid kas: '.PHP_EOL.
		'1) Heakskiita lingi külastades %s'.PHP_EOL.
		'Or:'.PHP_EOL.
		'2) Tagasi võtta lingi külastades %s'.PHP_EOL.
		PHP_EOL.
