...
//	'pi_links' => '',
	...
	'info_newlinks' => 'sinulle on %1% uutta linkkiä.',
	'info_search_exceed' => 'Haku ylitti tulos rajan %1%.',
	...
	'mt_linksec' => GWF_SITENAME.', Linkki, Lista, Linkit %1%',
	'md_linksec' => '%1% linkkiä sivulla '.GWF_SITENAME.'.',

	# Errors
	'err_gid' => 'Käyttäjä ryhmä ei kelpaa.',
	'err_score' => 'Virheelliset arvo pisteet.',
	'err_no_tag' => 'Ilmoitathan ainakin yhden tagin.',
	'err_tag' => 'Tagi %1% ei kelvannut ja se poistettiin. The tag has to be %2% - %3% bytes.',
	'err_url' => 'Sivun URL ei kelpaa.',
	'err_url_dup' => 'URL onjo listattu tänne.',
	'err_url_down' => 'URL ei ole etsittävissä.',
	'err_url_long' => 'Sinun URL on liian pitkä. Maksimi %1% bittiä.',
	'err_descr1_short' => 'Sinun kuvaus on liian lyhyt. Minimi %1% bittiä.',
	'err_descr1_long' => 'Kuvauksesi on liian pitkä. Maksimi %1% bittiä.',
	'err_descr2_short' => 'Sinun yksityiskohtainen kuvaus on liian lyhyt. Minimi %1% bittiä.',
	'err_descr2_long' => 'yksityis koihtainen kuvaus on liian pitkä. Maximi %1% bittiä.',
	...
	'err_score_tag' => 'sinun käyttäjälevel(%1%) ei ole tarpeeksi suuri jotta voisit lisätä toisen tagin. tarttettu Level: %2%.',
	'err_score_link' => 'sinun käyttäjälevel(%1%) ei ole taerpeeksi suuri jotta voisit lisätä uuden linkin. Needed Level: %2%.',
	'err_approved' => 'Linkki on jo hyväksytty. Käyttäkää henkilöstön osa ryhtymään toimiin.',
	'err_token' => 'Merkki ei kelpaa.',

	# Messages
//	'msg_redirecting' => 'Sinut ohjataan %1%.',
	...
	'mail_body' =>
		...
		PHP_EOL.
		'Description: %1%'.PHP_EOL.
		'Detailed D.: %2%'.PHP_EOL.
		'HREF / URL : %3%'.PHP_EOL.
		PHP_EOL.
		'You can either: '.PHP_EOL.
		'1) Approve this link by visiting %4%'.PHP_EOL.
		'Or:'.PHP_EOL.
		'2) Delete this link by visiting %5%'.PHP_EOL.
		PHP_EOL.
	...
	'permtext_score' => 'Tarvitset käyttäjä levelin %1% nähdäksesi tämän linkin',
	'permtext_member' => 'tämä linkki on vain käyttäjille',
	'permtext_group' => 'sinun pitää olla %1% ryhmässä nähdäksesi linkin',
