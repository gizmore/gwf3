<form action="/login" method="post" enctype="application/x-www-form-urlencoded" class="gwf_shortform">
	<fieldset>
	<label for="lf_username">{$lang->lang('th_username')}</label><input id="lf_username" type="text" name="username" value="">
	<label for="lf_password">{$lang->lang('th_password')}</label><input id="lf_password" type="password" name="password" value="">
