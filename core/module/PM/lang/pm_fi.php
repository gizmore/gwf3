...
$lang = array(
	...
	# Buttons
	'btn_ignore' => 'Laita %1% sivuutuslistallesi',
	...
	'err_title_len' => 'Otsikkosi on liian pitkä. Merkkien enimmäismäärä on %1%.',
	'err_no_msg' => 'Unohdit kirjoittaa viestin.',
	'err_sig_len' => 'Allekirjoituksesi on liian pitkä. Merkkien enimmäismäärä on %1%.',
	'err_msg_len' => 'Viestisi on liian pitkä. Merkkien enimmäismäärä on %1%.',
	...
	'err_limit' => 'Saavutit yksityisviestin enimmäismäärän tälle päivälle. Voit lähettää enintään %1% yksityisviestiä seuraavan ajan sisällä: %2%.',
	'err_ignored' => '%1% on laittanut sinut sivuutuslistalleen.<br/>%2%',
	'err_delete' => 'Viestiäsi poistettaessa tapahtui virhe.',
	'err_folder_exists' => 'Kansio on jo olemassa.',
	'err_folder_len' => 'Kansion nimen pituuden tulee olla 1 - %1% merkkiä.',
	...
	'msg_ignored' => 'Olet laittanut käyttäjän %1% sivuutuslistallesi.',
	'msg_unignored' => 'Poistit käyttäjän %1% sivuutuslistaltasi.',
	'msg_changed' => 'Asetuksiasi on muutettu.',
	'msg_deleted' => 'Poistettiin onnistuneesti %1% yksityisviestiä.',
	'msg_moved' => 'Siirrettiin onnistuneesti %1% yksityisviestiä.',
	'msg_edited' => 'Yksityisviestiäsi on muokattu.',
	'msg_restored' => 'Palautettiin onnistuneesti %1% yksityisviestiä.',
	'msg_auto_folder_off' => 'Et ole kytkenyt automaattisia kansioita päälle. Yksityisviesti on merkitty luetuksi.',
	'msg_auto_folder_none' => 'Tältä käyttäjältä/ tälle käyttäjälle on vain %1% viestiä. Mitään ei siirretty. Yksityisviesti on merkitty luetuksi.',
	'msg_auto_folder_created' => 'Luotiin kansio %1%.',
	'msg_auto_folder_moved' => 'Siirrettiin %1% viesti(ä) kansioon %2%. Yksityisviesti(t) merkitty luetu(i)ksi.',
	'msg_auto_folder_done' => 'Automaattiset kansiot tehty.',


	# Titles
	'ft_create' => 'Kirjoita %1%:lle uusi yksityisviesti',
...
//	'th_pm_options' => 'Asetukset',
	...
	# New PM Email
	'mail_subj' => GWF_SITENAME.': Uusi yksityisviesti käyttäjältä %1%',
	'mail_body' =>
		'Tervehdys, %1%'.PHP_EOL.
		PHP_EOL.
		'Sinulle on uusi yksityisviesti sivustolla '.GWF_SITENAME.'.'.PHP_EOL.
		PHP_EOL.
		'Käyttäjältä: %2%'.PHP_EOL.
		'Otsikko: %3%'.PHP_EOL.
		PHP_EOL.
		'%4%'.PHP_EOL.
		PHP_EOL.
	...
	# v2.02
	'msg_mail_sent' => 'Sähköpostiviesti lähetetty käyttäjälle %1% sisältäen alkuperäisen viestisi.',
	...
	'msg_folder_deleted' => 'Kansio %1% ja %2% viesti(ä) siirrettiin roskakoriin.',
	'cfg_pm_delete' => 'Hyväksy yksityisviestin poisto?',
	'ft_empty' => 'Tyhjennä roskakorisi',
	'msg_empty' => 'Roskakorisi (%1% messages) on tyhjennetty.<br/>%2% viesti(ä) on poistettu tietokannasta.<br/>%3% viestiä ovat edelleen käytössä toisella käyttäjällä, eikä niitä poistettu.',
	# v2.08 (GT)
