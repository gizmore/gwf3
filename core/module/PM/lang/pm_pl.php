...
$lang = array(
	...
	# Buttons
	'btn_ignore' => 'Umieść %1$s na liście do zignorowania',
	'btn_ignore2' => 'Ignoruj',
	...
	'err_title_len' => 'Twój tytuł jest za długi. Wpisz maksymalnie %1$s znaków.',
	'err_no_msg' => 'Nie wpisałeś treści wiadomości.',
	'err_sig_len' => 'Twój podpis jest zbyt długi. Wpisz maksymalnie %1$s znaków.',
	'err_msg_len' => 'Twoje PW jest zbyt długie. Wpisz maksymalnie %1$s znaków.',
	...
	'err_limit' => 'Osiagnąłeś limit wysyłania prywatnych wiadomości. Możesz wysłać maksymalnie %1$s PW w czasie %2$s.',
	'err_ignored' => '%1$s umieścił Cię na liście osób ignorowanych.<br/>%2$s',
	'err_delete' => 'Wystąpił błąd podczas usuwania wiadomości.',
	'err_folder_exists' => 'Taki folder już istnieje.',
	'err_folder_len' => 'Nazwa folderu powinna posiadać od 1 do %1$s znaków.',
	...
	'msg_ignored' => 'Umieściłeś %1$s na liście do ignorowania.',
	'msg_unignored' => 'Usunąłeś %1$s z listy do ignorowania.',
	'msg_changed' => 'Twoje opcje uległy zmianie.',
	'msg_deleted' => 'Pomyślnie usunięto %1$s prywatnych wiadomości.',
	'msg_moved' => 'Pomyślnie przeniesiono %1$s prywatnych wiadomości.',
	'msg_edited' => 'Twoje PW zostało zedytowane.',
	'msg_restored' => 'Pomyślnie odzyskano %1$s prywatnych wiadomości.',
	'msg_auto_folder_off' => 'Nie posiadasz włączonych opcji Auto-Folderu. PW zostało zaznaczone jako przeczytane.',
	'msg_auto_folder_none' => 'Jest tylko %1$s wiadomości od/do tego użytkownika. Nic nie zostało przeniesione. PW zostały znaznaczone jako przeczytane.',
	'msg_auto_folder_created' => 'Utwórz folder %1$s.',
	'msg_auto_folder_moved' => 'Przenieś %1$s wiadomości do folderu %2$s. Wszystkie PW zostały oznaczone jako przeczytane.',
	'msg_auto_folder_done' => 'Auto-Foldery stworzone.',


	# Titles
	'ft_create' => 'Napisz do %1$s nowe PW',
	'ft_preview' => 'Podgląd',
	'ft_options' => 'Twoje ustawienia PW',
	'ft_ignore' => 'Umieść kogoś na liście do ignorowania',
	'ft_new_pm' => 'Napisz nowe PW',
	'ft_reply' => 'Odpowiedz do %1$s',
	'ft_edit' => 'Edytuj PW',
...
//	'th_pm_options' => 'Opcje',
	...
	# New PM Email
	'mail_subj' => GWF_SITENAME.'Nowe PW od %1$s',
	'mail_body' =>
		'Cześć %1$s'.PHP_EOL.
		PHP_EOL.
	...
	# v2.02
	'msg_mail_sent' => 'E-mail, zawierający Twoją oryginalną wiadomość został wysłany do %1$s .',
