<?php
$lang = array(
	'msg_sent_mail' => 'Hemos enviado un email a %1%. Por favor, siga las instrucciones que contiene.',
...
# same message! no spoiled connection from uname=>email 
	...
	'info_change' => 'Puede introducir una nueva contraseña para su cuenta, %1%.',
	...
	'mail_body' => 
		...
		'Si no pidió el cambio, ignore este mensaje o contáctenos en %2%.'.PHP_EOL.
		''.PHP_EOL.
		'%3%'.PHP_EOL.
		''.PHP_EOL.
		'Atentamente,'.PHP_EOL.
	...
	# v2.01 (fixes)
	'err_weak_pass' => 'Tu contraseña es demasiado débil. El mínimo son %1% caracteres.',
);
?>
