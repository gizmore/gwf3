...
$lang = array(
	...
	'msg_sent_mail' => 'Olemme lähettäneet sähköpostiviestin osoitteeseen %1%. Ole hyvä ja seuraa viestin ohjeita.',
	...
	'info_change' => 'Voit nyt antaa uuden salasanan tunnuksellesi %1%.',
	...
	'mail_body' => 
		...
		'Jos et pyytänyt salasanasi vaihtoa, jätä tämä viesti huomiotta tai ota meihin yhteyttä: <a href="mailto:%2%">%2%</a>.<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
		'%3%<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
	...
	# v2.01 (fixes)
	'err_weak_pass' => 'Salasanasi on liian lyhyt. Tarvitset vähintään %1% merkkiä.',
);
