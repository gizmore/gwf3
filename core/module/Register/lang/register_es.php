...
$lang = array(
	...
	'th_tos2' => 'Estoy de acuerdo con los<br/><a href="%1%">Términos de Uso</a>',
	...
	'regmail_ptbody' =>
		...
		'<b>Nombre de usuario: %1%'.PHP_EOL.
		'Contraseña: %2%</b>'.PHP_EOL.
		''.PHP_EOL.
	...
	'err_minage' => 'Lo sentimos, pero no tiene edad suficiente para registrarse. Necesita tener al menos %1% años.',
	'err_ip_timeout' => 'Alguien registró una cuenta con esta IP recientemente.',
	
	'th_token' => 'Token',
	'th_timestamp' => 'Tiempo de registro',
	'th_ip' => 'Registrar IP',
	'tt_username' => 'Nombre de usuario debe empezar por una letra.'.PHP_EOL.'Sólo puede contener letras, dígitos y guión bajo. Length has to be 3 - %1% chars.',
