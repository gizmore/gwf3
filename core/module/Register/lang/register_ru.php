...
$lang = array(
	...
	'th_tos2' => 'Я согласен с<br/><a href="%1$s">Условиями Сайта</a>',
	...
	'err_minage' => 'Очень жаль, но Вы ещё очень молоды для регистрации. Вам должно быть хотя бы %1$s лет.',
	'err_ip_timeout' => 'Кто-то недавно уже зарегистрировался с этого IP.',
	'th_token' => 'Токен',
	'th_timestamp' => 'Время регистрации',
	'th_ip' => 'Регистрационный IP',
	'tt_username' => 'Имя должно начинаться с символа.'.PHP_EOL.'Это могут быть только буквы, цифры и знак подчеркивания. Длина должна быть от 3 до %1$s символов.', 
