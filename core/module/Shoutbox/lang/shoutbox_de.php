...
$lang = array(
	...
	# History
	'pt_history' => GWF_SITENAME.' Shoutbox Aufzeichnung (Seite %s / %s)',
	...
	# Errors
	'err_flood_time' => 'Bitte warte %s bevor du erneut eine Nachricht absendest.',
	'err_flood_limit' => 'Du hast dein Limit von %s Nachrichten pro Tag erreicht.',
	'err_message' => 'Deine Nachricht muss zwischen %s und %s Zeichen lang sein.',
	
	# Messages
	'msg_shouted' => 'Deine Nachricht wurde in die Shoutbox eingetragen.<br/>Zurück zu <a href="%s">%s</a>.',
