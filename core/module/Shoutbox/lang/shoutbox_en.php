...
$lang = array(
	...
	# History
	'pt_history' => GWF_SITENAME.' Shoutbox History (Page %1$s / %2$s)',
	...
	# Errors
	'err_flood_time' => 'Please wait %1$s before you shout again.',
	'err_flood_limit' => 'You have exceeded your limit of %1$s messages per day.',
	'err_message' => 'Your message has to be between %1$s to %2$s characters long.',
	
	# Messages
	'msg_shouted' => 'Your shoutbox entry has been added.<br/>Go back to <a href="%1$s">%1$s</a>.',
