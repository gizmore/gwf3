...
$lang = array(
	...
	# History
	'pt_history' => GWF_SITENAME.' Shoutbox Historia (Page %s / %s)',
	...
	'err_message' => 'Usted mensaje tiene que ser entre %s y el %s caracteres de largo.',
	
	# Messages
	'msg_shouted' => 'Grito con éxito.<br/>Go back to <a href="%s">%s</a>.',
