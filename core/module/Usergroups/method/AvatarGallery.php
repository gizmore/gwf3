...
final class Usergroups_AvatarGallery extends GWF_Method
{
	...
	private function page(Module_Usergroups $module)
	{
		...
		$num_x = $module->cfgAvatarsX();
		$num_y = $module->cfgAvatarsY();
		$ipp = $num_x * $num_y;
		...
		GWF_Website::setPageTitle($module->lang('pt_avatars'));
		GWF_Website::setMetaDescr($module->lang('md_avatars'));
		GWF_Website::setMetaTags($module->lang('mt_avatars'));
		...
		return $module->templatePHP('avatars.php', $tVars);
	}
}
