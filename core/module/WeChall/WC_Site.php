...
class WC_Site extends WC_SiteBase
{
    ...
    const NO_EMAIL = 0x100; // Site uses an auth token generated by the site. Token is unique_per_user@site.url, so it passes the email test. Email validation is skipped for this site.
...
// 	public function getWarReduceScore() { return $this->getVar('site_war_rs'); } # Score reduce for warbox
    ...
    public function hasNoEmail() { return $this->isOptionEnabled(self::NO_EMAIL); }
