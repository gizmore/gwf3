...
$lang = array(
	...
	'join_0_b' =>
		'These pages are for challenge site administrators. See <a href="%1%">WeChall API section</a> for player scripts.<br/>'.
	...
	'join_1b' =>
		...
		'<br/>'.
		'<a href="%1%" onclick="toggleHidden(\'example_1_1\'); return false;">Click here to see an example implementation in PHP</a><br/>'.
		'<div id="example_1_1" class="gwf_code" style="display: %2%;"><pre>'.
	...
	'join_2b' =>
		...
		'<br/>'.PHP_EOL.
		'<a href="%1%" onclick="toggleHidden(\'example_2_1\'); return false;">Click here to see an example implementation in PHP</a><br/>'.
		'<div id="example_2_1" class="gwf_code" style="display: %2%;"><pre>'.
	...
	'join_5b' =>
		...
		'<a href="%1%" onclick="toggleHidden(\'example_5_1\'); return false;">Click here to view example code</a><br/>'.
		'<div id="example_5_1" style="display: %2%;">'.
		'Example: <br/>'.
		'<br/>'.
		'<div class="gwf_code">'.
		...
		'<a href="%3%" onclick="toggleHidden(\'example_5_2\'); return false;">Click here to view example code</a><br/>'.
		'<div id="example_5_2" style="display: %4%;">'.
		'Example:<br/>'.
		'<div class="gwf_code">'.
	...
	'join_7b' =>
		...
		'<br/>'.
		'<a href="%1%" onclick="toggleHidden(\'example_7_1\'); return false;">Click here for an example on the server side</a><br/>'.
		'<pre class="gwf_code" style="display: %2%;" id="example_7_1">'.
		'%3%'.
		'</pre>'.
		'<br/>'.
		'<a href="%4%" onclick="toggleHidden(\'example_7_2\'); return false;">Click here for an example on the client side</a><br/>'.
		'<pre class="gwf_code" style="display: %5%;" id="example_7_2">'.
		'%6%'.
		'</pre>'.
		'<br/>'.
	...
	'api_1b' =>
		'WeChall does implement the <a href="%1%">optional script 7</a>.<br/>'.
		...
		'<br/>'.
		'The output of this script is explained in the <a href="%1%">optional join documentation</a>.',
	
	'api_2t' => 'Poll user statistics',
	'api_2b' =>
		'WeChall does implement an enhanced version for <a href="%1%">optional script 6</a>.<br/>'.
		...
		'<br/>'.
		'To list all possible sites, use <a href="%5%">%5%</a>.<br/>',
