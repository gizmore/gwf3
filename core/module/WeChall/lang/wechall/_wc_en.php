...
$lang = array(
	...
	'it_graph_siteusers' => 'Number of Users on %s',
	'it_graph_sitechalls' => 'Number of Challenges on %s',

	# Sitemaster News
	'mnews_title' => 'Sitemaster News',
	'mnews_body' => 'Some player(s) reached 100%% on a challenge site. Very well done :)'.PHP_EOL.'You can [url=%s]see all site masters here[/url].',
	'mnews_item' => '[url=/profile/%s]%s[/url] reached 100%% on [url=%s]%s[/url] after %s of being linked, starting from %s.',
	...
	'pt_site_ranking' => '%s Ranking - Page %s',
	'pt_ranking' => 'Global Ranking - Page %s',
	...
	'pi_login_link' => '<a href="%s">Click here to return to your last location: %s</a>',
	'pi_site_urls' => 'The script urls substitute %USERNAME%, %EMAIL% and %AUTHKEY%.',
	'pi_ug_info' => '%s is founder of the group &quot;%s&quot; which has %s members.',
	...
	'head_users' => '<a href="%s">New Users</a>',
	...
	'tt_challs_for' => '%s Challenge(s) Overview for %s',
	'tt_challs_from' => '%s %s Challenges contributed by %s',

	# Form Titles
	'ft_solution' => 'Your solution for %s',
	...
	'ft_edit_site' => 'Edit %s',
	'ft_edit_site_logo' => 'Edit %s Logo',
	'ft_edit_site_admin' => 'Add or Remove Site Admin',
	'ft_vote_chall' => 'Vote for the %s challenge',

	# Graph Titles
	'gt_site_sitehist_score' => 'Scoregraph for %s',
	'gt_site_sitehist_usercount' => 'Number of Users on %s',
	'gt_site_sitehist_challcount' => 'Number of Challenges on %s',
	'gt_user_level' => 'Totalscore Graph for %s',
	...
	'rp_usercount' => '%s Users',
	'rp_sites' => '%s Active Sites',
	'rp_topusers' => 'Top %s Players',
	'rp_last_active' => 'Last %s Activities',
    'rp_donations' => '%s Donations',
    'rp_shop' => '%s Shop',

	#Left Panel
	'lp_last_online' => 'Online within %s',
	'lp_last_online2' => '<a href="%s">%s Users</a>',
	...
	'th_last_activites' => '%s`s latest activities',
...
%s<br/>
<br/>
The problem is randomly generated and is bound to your session.<br/>
<br/>
Good Luck!<br/>
The WeChall Team',
