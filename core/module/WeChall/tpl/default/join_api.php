...
echo GWF_Box::box($l->lang('api_3b', array($usage_3_1, $event_types, $examples)), $l->lang('api_3t'));
...
echo GWF_Box::box($l->lang('api_4b', array($usage_4_1, $example_4_1, $example_4_2)), $l->lang('api_4t'));
...
echo GWF_Box::box($l->lang('api_5b', array($usage_5_1, $example_5_1, $example_5_2)), $l->lang('api_5t'));
