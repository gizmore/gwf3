...
$lang = array(
	...
	'th_demo' => 'Opciones demográficas: Puede cambiarlas sólo una vez en %1%.',
	'th_countryid' => 'País',
	...
	'err_demo_wait' => 'Cambió sus opciones demográficas recientemente. Por favor, espere %1%.',
	'err_birthdate' => 'Su fecha de nacimiento no es válida.',
	# Messages
	'msg_mail_changed' => 'Su email de contacto ha sido cambiado a <b>%1%</b>.',
	...
	'chdemo_body' => 
		...
		'Puede hacerlo sólo una vez en %2%, por lo tanto, por favor, asegúrese de que su configuración es correcta antes de continuar.'.PHP_EOL.
		PHP_EOL.
		'Sexo: %3%'.PHP_EOL.
		'País: %4%'.PHP_EOL.
		'Idioma principal: %5%'.PHP_EOL.
		'Idioma secundario: %6%'.PHP_EOL.
		'Fecha de nacimiento: %7%'.PHP_EOL.
		PHP_EOL.
	...
	'ms_accrm' => GWF_SITENAME.': Borrado de cuenta de %1% ',
	'mb_accrm' =>
		'Estimado Staff'.PHP_EOL.
		''.PHP_EOL.
		'El usuario %1% acaba de borrar su cuenta y dejó esta nota (puede estar vacía):'.PHP_EOL.PHP_EOL.
		'%2%',
	...
	'err_no_gpg_key' => 'El usuario %1% no ha enviado una clave pública todavía.',
...
El personal de '.GWF_SITENAME,
	...
	# 204
	'th_change_pw' => '<a href="%1%">Cambia tu contraseña</a>',
