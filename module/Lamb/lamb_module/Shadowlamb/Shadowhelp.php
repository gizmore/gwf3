...
final class Shadowhelp
{
	public static function getAllHelp(SR_Player $player)
	{
		...
		$back = array(
			...
			'xp' => "Collect ".'11'." XP and gain 1 {$b}Karma{$b}. With Karma you can {$c}{$b}levelup{$b}.",
			'karma' => "With karma you can #{$b}levelup{$b} your skills, attributes and spells.",
			'levelup' => "Use #levelup to spend karma on a skill, attribute or spell.",
