...
final class Redmond_Blacksmith extends SR_Blacksmith
{
	...
	public function getFoundText() { return 'You find a small store, "The Blacksmith". It seems like they can upgrade your equipment here.'; }
	...
	{
		return array(
			array('Rune_of_strength:0.5', 1200),
			array('Rune_of_quickness:0.5', 1800),
			array('Rune_of_melee:0.25', 2400),
		);
	}
