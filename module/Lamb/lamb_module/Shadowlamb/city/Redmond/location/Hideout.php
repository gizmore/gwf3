...
final class Redmond_Hideout extends SR_Tower
{
	...
	public function getFoundText() { return 'You see two punks coming out of a ruinous house. You stealthy move to one of the windows. Seems like this is one of the Punks hideout.'; }
