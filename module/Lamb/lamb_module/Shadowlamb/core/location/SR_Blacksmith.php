...
abstract class SR_Blacksmith extends SR_Store
{
	...
	public function getHelpText(SR_Player $player) { $c = Shadowrun4::SR_SHORTCUT; return "At a blacksmith you can {$c}upgrade equipment with runes. Do {$c}simulate first if you like to see the odds. You can also {$c}break items into runes or {$c}clean them. Also {$c}view, {$c}buy and {$c}sell works here."; }
