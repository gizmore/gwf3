<?php # Usage: %TRIGGER%mode <username> <modebit>. Set the server-global mode for a username. bits: asohvpb (admin staff op halfop voice public bot). A user can have only one bit set.
$bot instanceof Lamb;
