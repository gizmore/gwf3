...
echo GWF_Box::box($tLang->lang('solved_by_text', $title), $tLang->lang('solved_by_title', $title, $href));

echo $tVars['pagemenu'];

echo '<table>'.PHP_EOL;
echo GWF_Table::displayHeaders(GWF_Table::getHeaders2($headers, $tVars['sort_url']));
