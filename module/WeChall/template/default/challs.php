<?php
GWF_Module::getModule('Forum', true);
...
echo GWF_Table::displayHeaders($headers, $raw);
$is_admin = GWF_User::isAdminS();

$icon_vote = GWF_WEB_ROOT.'template/wc/ico/vote.gif';
$icon_voted = GWF_WEB_ROOT.'template/wc/ico/voted.gif';
$icon_novote = GWF_WEB_ROOT.'template/wc/ico/show_votes.gif';
