...
echo GWF_Box::box($l->lang('join_0_b', $url_api), $l->lang('join_0_t'));
...
echo GWF_Box::box($l->lang('join_1b', $url_1_1, $hidden_1_1), '1) '.$l->lang('join_1t'));
echo '<a name="join_2"></a>'.PHP_EOL;
echo GWF_Box::box($l->lang('join_2b', $url_2_1, $hidden_2_1), '2) '.$l->lang('join_2t'));
