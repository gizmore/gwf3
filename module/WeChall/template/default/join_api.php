...
echo GWF_Box::box($l->lang('api_1b', $href_opt_7), $l->lang('api_1t'));
...
echo GWF_Box::box($l->lang('api_2b', $href_opt_6, $example_6_1, $example_6_2, $example_6_3, $example_6_4), $l->lang('api_2t'));
...
$examples = array(
	'username=HaDeS',
	'username=HaDeS&limit=50',
	'username=HaDeS&sitename=Yashira',
	'username=HaDeS&sitename=Yashira&datestamp=20100403204635&limit=10',
);
...
echo GWF_Box::box($l->lang('api_3b', $usage_3_1, $event_types, $examples), $l->lang('api_3t'));
...
echo GWF_Box::box($l->lang('api_4b', $usage_4_1, $example_4_1, $example_4_2), $l->lang('api_4t'));
...
echo GWF_Box::box($l->lang('api_5b', $usage_5_1, $example_5_1, $example_5_2), $l->lang('api_5t'));
