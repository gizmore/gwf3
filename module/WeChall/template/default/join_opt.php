...
echo GWF_Box::box($l->lang('join_5b', $url_5_1, $hidden_5_1, $url_5_2, $hidden_5_2), '5) '.$l->lang('join_5t'));
...
echo GWF_Box::box($l->lang('join_7b', $url_7_1, $hidden_7_1, $code_7_1, $url_7_2, $hidden_7_2, $code_7_2), '7) '.$l->lang('join_7t'));
