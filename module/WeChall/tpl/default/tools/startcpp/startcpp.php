...
echo GWF_Box::box($tVars['lang']->lang('box_1_b', array($href1, $href2)), $tVars['lang']->lang('box_1_t'));

echo GWF_Box::box($tVars['lang']->lang('box_2_b'), $tVars['lang']->lang('box_2_t'));

echo GWF_Box::box($tVars['lang']->lang('box_3_b'), $tVars['lang']->lang('box_3_t'));

echo GWF_Box::box($tVars['lang']->lang('box_4_b'), $tVars['lang']->lang('box_4_t'));
...
echo GWF_Box::box($tVars['lang']->lang('box_5_b', array($href1, $href2, $href3, $href4, $href5, $href6, $href7)), $tVars['lang']->lang('box_5_t'));
?>