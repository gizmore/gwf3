...
define('GWF_DB_USER', 'gwf3_test'); # Database username. Example: 'some_sql_username'.
define('GWF_DB_PASSWORD', ''); # Database password.
define('GWF_DB_DATABASE', 'gwf3_test'); # Database db-name.
...
define('GWF_TABLE_PREFIX', ''); # Database table prefix. Example: 'gwf3_'.
