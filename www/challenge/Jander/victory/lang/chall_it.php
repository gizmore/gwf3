...
//		'I found <a href="%1$s">this recording</a>, but can\'t remember what\'s on it.<br/>'.PHP_EOL.
		...
		'C\'è qualcosa di sbagliato nella registrazione. Puoi trovare che cosa è?<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
		'Attenzione: Il file audio non è pensato per essere ascoltato ad alto volume!'.PHP_EOL,
);
?>