...
$lang = array(
	...
	'index_info' =>
		...
		'Dopo aver raccolto alcune informazioni tramite social engineering, sei venuto a conoscenza del fatto che VSA vuole ordinare alcuni semplici programmi dall\'azienda SoftMicro, specializzata nello sviluppo di software.<br/>'.
	...
	'upload_info' =>
		...
		'<br/><br/>'.
		'Lo script verifica se i due binari fanno quello che è richiesto, e se la loro md5sum è uguale.<br/>'.
		'<br/>'.
