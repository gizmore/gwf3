...
$lang = array(
	'index_info' => 
		...
		'<br/>'.
		'You have found a source code for a web application, which is vulnerable to sql-injection and xss attacks. This web application runs on the <a href="%1$s">mainframe (accessible only from the internal network).</a> <a href="%2$s"> Here you can download the source code.</a><br/>'.
		'<br/>'.
		...
		'<br/>'.
		'Your mission is to send a special id to <a href="%4$s">GLaDOS</a>, in order to steal the cookie data.<br/>'.
