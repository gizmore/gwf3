...
$lang = array(
	'index_info' => 
		...
		'<br/>'.
		'La brutta notizia è che non puoi accedere al mainframe senza il cookie, solo GLaDOS può. Un\'altra brutta notizia è che l\'utente www-user ha solo il permesso di lettura su database del mainframe e non è possibile eseguire più query con la stessa richiesta.<br/>'.
		'<br/>'.
		...
		'<br/>'.
		'Durante la tua missione hai ottenuto l\'accesso ad un webserver di prova ed hai installato un file php, a cui si può accedere, tramite la rete locale, utilizzando questo link:<br/>'.
		...
		'<b>magic_quotes_gpc è disabilitato sul mainframe</b><br/>',
);
?>
