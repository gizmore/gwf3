...
$lang = array(
	...
	'info' =>
		'This challenge is the sequel to the &quot;Blinded by the light&quot; challenge.<br/>'.PHP_EOL.
		'Again your mission is to extract an md5 password hash out of the database.<br/>'.PHP_EOL.
		'This time your limit for this blind sql injection are %s queries.<br/>'.PHP_EOL.
		'Also you have to accomplish this task %s times consecutively, to prove you have solved the challenge.<br/>'.PHP_EOL.
		'You are also given <a href="%s">the sourcecode</a> of the vulnerable script, also as <a href="%s">highlighted version</a>.<br/>'.PHP_EOL.
		'To restart the challenge, you can <a href="%s">execute a reset</a>.<br/>'.PHP_EOL.
		'%s<br/>'.PHP_EOL.
		'Thanks go out to %s for his help in developing and testing the challenge.<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
		'Good luck!',
