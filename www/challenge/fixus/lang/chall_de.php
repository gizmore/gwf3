...
$lang = array(
	'title' => 'Fix us',
	'info' =>
		'Deine Aufgabe ist es Zugriffsrechte auf die geheimen Lösungs-Foren zu den Z Challenges zu erhalten.<br/>'.
		'Dein Plan ist Informationen über die Challenge Lösungen zu ergaunern, um deine Punktzahl auf wechall.net zu erhöhen.<br/>'.
		'Z ist naiv, "Erst Klicken, dann Denken", und klickt sofort auf jeden Link den du ihm schickst.<br/>'.
		'Dein weiterer Plan ist es, Z einen bösen aber unauffälligen Link zu schicken, und sobald er sich einloggt erhälst du ebenfalls Zugriff auf die Lösung-Boards.<br/>'.
