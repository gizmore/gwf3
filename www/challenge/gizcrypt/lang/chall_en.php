...
$lang = array(
	...
	'info' =>
		...
		'<br/>'.PHP_EOL.
		'You can <a href="%1$s">take a look at the algorithm</a>, also as <a href="%2$s">highlighted version</a>.<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
		...
		'%4$s'.PHP_EOL.
		'</pre>'.PHP_EOL.
		'You can also <a href="%5$s">download the ciphertext as a file</a>.<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
