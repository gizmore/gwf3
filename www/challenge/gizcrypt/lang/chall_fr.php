...
$lang = array(
    ...
    'info' =>
        'J\'ai créé un chiffrement symmétrique pour ajouter une couche de sécurité à l\'obfuscation de mes projets.<br/>'.PHP_EOL.
        ...
        '%4$s'.PHP_EOL.
        '</pre>'.PHP_EOL.
        'Vous pouvez aussi <a href="%5$s">télécharger le texte chiffrer sous forme de fichier</a>.<br/>'.PHP_EOL.
        '<br/>'.PHP_EOL.
        'Indice supplémentaire : la clé secrète fait 11 caratères, et contient seulement [a-zA-Z].<br/>'.PHP_EOL.
