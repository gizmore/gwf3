<?php
$lang = array(
	'msg_title' => 'Compte Craqué',
	'msg_wechall' => 
		'Je pense que certaines personnes ont craqué mon compte wechall.'.PHP_EOL.
		'Pensez-vous réellement que vos scripts sont sûrs ?',
	'msg_gizmore' =>
		'Eh bien, peut-être que votre mot de passe a été très facile à deviner ou que vous le réutilisez d'un autre site ?'.PHP_EOL.
		'Ne choisissez pas des mots de passe qui sont affiliés au site et à votre personne etc ...'.PHP_EOL.
		'Vous devriez peut-être réinitialiser votre mot de passe ?'.PHP_EOL.
		PHP_EOL.
		'gizmore'.PHP_EOL.
		PHP_EOL.
