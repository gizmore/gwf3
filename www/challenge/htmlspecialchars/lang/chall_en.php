...
$lang = array(
	...
	'info' => 
		...
		'[url=%2%]Common::getPost[/url] only fetches a string from the [url=%3%]$_POST variables[/url] and applies [url=%4%]stripslashes()[/url], in case [url=%5%]magic_quotes_gpc()[/url] are enabled.'.PHP_EOL.
		'You can ignore [url=%2%]Common::getPost[/url] completely, replace it by $_POST[\'input\'], and assume [url=%5%]magic_quotes_gpc()[/url] are disabled.'.PHP_EOL.
		PHP_EOL.
		'Below the input box is the output of the script, to test your attacks.'.PHP_EOL.
		'You will fail anyway, because i used [url=%6%]htmlspecialchars()[/url] to prevent XSS.'.PHP_EOL.
		PHP_EOL.
