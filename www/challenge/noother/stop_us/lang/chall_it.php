...
$lang = array(
	...
	'info' =>
		...
		'C\'è un secondo file che viene utilizzato durante l\'acquisto: <a href="%4$s">noothtable.php</a>, anche <a href="%5$s">versione evidenziata</a>, ma probabilmente non ti serve.<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
		'Buona fortuna!<br/>'.PHP_EOL.
		'<br/>'.PHP_EOL.
		'Grazie a %6$s e %7$s per aver testato la sfida.<br/>'.PHP_EOL.
		'',
);
?>