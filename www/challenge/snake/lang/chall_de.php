...
$lang = array(
	...
	'info' =>
		...
		'- Benutze CrsrLinks und CrsrRechts um die Schlange zu drehen.<br/>'.
		'- Benutze CrsrHoch und CrsrRunter um die Geschwindigkeit leicht anzupassen.<br/>'.
		'- Krieche nicht in deine eigene Scheisse.<br/>'.
		'- Die Schlange verhungert wenn du sie nicht fütterst.<br/>'.
		'- Wenn du Hanf gefressen hast, ist die Steuerung vertauscht.<br/>'.
		'- Sammele Buchstaben für Punkte-Multiplikator.<br/>'.
		'- Hanf erhöht die Wahrscheinlichkeit auf Bonus-Buchstaben.<br/>'.
		'<br/>'.
		'<b>Notizen</b>:<br/>'.
