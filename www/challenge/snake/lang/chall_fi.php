...
$lang = array(
	...
	'info' =>
		...
		'- Käytä nuolinäppäimistön vasenta- ja oikeaanuolta kiertääksesi käärmettä.<br/>'.
		'- Käytä nuolinäppäimistön ylös- ja alasnuolia säätääksesi nopeutta hieman.<br/>'.
		'- Älä kävele omaan kakkaasi.<br/>'.
		'- Käärme kuolee nälkään jos sinulla et ruoki sitä.<br/>'.
		'- Hampun syöminen  vaihtaa oikean vasemmalle ja vasemman oikalle ohjauksessa.<br/>'.
		'- Kerää kirjaimia saadaksesi pistekertoimia.<br/>'.
		'- Hamppu lisää kirjainten ilmestymistiheyttä.<br/>'.
		'<br/>'.
		'<b>Huomioitavaa</b>:<br/>'.
