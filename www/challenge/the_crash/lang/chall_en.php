...
$lang = array(
	'title' => 'The Crash',
	'info' =>
		'My system harddisk crashed and i have lost the key to all my encrypted harddisks.<br/>'.PHP_EOL.
		...
		'<br/>'.PHP_EOL.
		'Note: The password is bound to your session and the plaintext was some php script i wrote. You can <a href="%s" title="The ciphertext">download the ciphertext here</a>.<br/>'.PHP_EOL.
