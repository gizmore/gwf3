<?php
$lang = array(
	'title' => 'Codifiche - Il ritorno di Bacon',
	'info' =>
		'Il sig. <a href="%1$s">Bacon</a> è tornato e vuole sfidarti ancora.<br/>'.
		'Questa volta il metodo di decodifica è più difficile. Ho cambiato il codificatore dopo aver cercato il cifrario di Bacon sul Web.<br/>'.
		'<br/>'.
		'Nota 1: Utilizziamo un alfabeto di 26 caratteri.<br/>'.
		'Nota 2: X sta per uno spazio come separatore tra parole.<br/>'.
		'Nota 3: La tua soluzione è ancora casuale e legata alla tua sessione.',
	...
	'hidden' => 'Puoi leggere il messaggio nascosto quindi ti devo dire la soluzione composta da dodice lettere casuali %1$s',
);
?>