...
$lang = array(
	...
	'info' =>
		...
		'<br/>'.PHP_EOL.
		'Pour les besoins de débogage, vous pouvez accéder au <a href="%3$s">code source entier</a>, ainsi qu'a sa <a href="%4$s">version surlignée</a>.<br/>'.PHP_EOL.
		'',

	'example_title' => 'Le script vulnérable en action',
	'err_basedir' => 'Ce dossier n'est pas une partie du challenge.',
	'credits' => 'Merci à %1$s pour ces alpha tests, sa motivation et ces brillantes idées!',
	'msg_solved' => 'Bien joué. Si vous trouvez une faille de type local file inclusion, généralement la boîte peut se piraté en quelques minutes.',
);
?>