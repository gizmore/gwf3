...
$lang = array(
	...
	# Levels
	'info_1' =>
		'Il tuo obiettivo in questa sfida è di imparare ad utilizzare le Espressioni Regolari.<br/>'.PHP_EOL.
	...
	'info_3' => 
		'Ok, identificare stringhe statiche non è lo scopo per cui le Espressioni Regolari sono state ideate.<br/>'.PHP_EOL.
		'Il tuo prossimo compito è di inviare una espressione che identifichi dei nomi di file validi per certe immagini.<br/>'.PHP_EOL.
		...
		'Ecco alcuni esempi di nomi di file validi: wechall4.tiff, wechall.png, wechall4.jpg, wechall.bmp',

	'info_4' =>
		'Adesso che possiamo cattuarare immagini valide, potresti catturare il nome del file, senza estensione? Sarebbe veramente utile.<br/>'.PHP_EOL.
