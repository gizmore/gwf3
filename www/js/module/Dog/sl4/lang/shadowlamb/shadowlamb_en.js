...
'busy':'%s busy.',
'eta':'ETA: %s.',
'hits1':', hits %s with %s damage',
'hits2':', hits %s with %s(%s/%s)HP left',
'kills':', kills %s with %s',
...
'fmt_examine':'%s is %s%s. %s%s%s%s%s%s%s%s%s',
'fmt_list':', %s',
'fmt_gain':'%s%s(%s/%s)%s',
'fmt_asl':'Age:%s, %scm %s',
...
'pa_delete':'being deleted.',
'pa_talk':'talking to %s. %s remaining. Last action: %s',
'pa_fight':'fighting against %s. Last action: %s',
'pa_inside':'inside %s.',
'pa_outside1':'outside of %s.',
'pa_outside2':'somewhere inside %s.',
'pa_sleep':'sleeping inside %s.',
'pa_travel':'travelling to %s. %s remaining.',
'pa_explore':'exploring %s. %s remaining.',
'pa_goto':'going to %s. %s remaining.',
'pa_hunt':'hunting %s. %s remaining.',
'pa_hijack':'hijacking %s at %s. %s remaining.',
'qu_open':'Open',
'qu_deny':'Denied',
'qu_done':'Done',
'qu_fail':'Failed',
...
'sum_bmi':'body masses',
'sum_height':'heights',
'stub_found':'You found the %s. There is no description yet.',
'stub_enter':'You enter the %s. There is no text yet.',
'stub_shop_slogan':'Welcome to %s\'s shop.',
'stub_found_bazar':'You found the local bazar, a place where you can offer your items and purchase them.',
'stub_enter_bazar':'You enter the bazar. You see %s shops with a total of %s items.',
...
'ch_0':'%s created the clan %s.',
'ch_1':'%s requested to join your clan as member #%s.',
'ch_2':'%s has joined your clan as member #%s.',
'ch_3':'%s has left your clan and it now holds %s members.',
'ch_4':'%s: "%s"',
'ch_5':'%s has pushed %s into the clanbank.',
'ch_6':'%s has taken %s out of the clanbank.',
...
'start_4':'Use #c to see all available commands. Check #help to browse the Shadowlamb help files. Use #help <cmd> to see the help for a command.',
'ks_words':'Word',
'ks_spells':'Spell',
'ks_places':'Place',
'kp_words':'Words',
...
'1002':'You need at least level %s to shout.',
'1004':'You have no %s quests.',
...
'5000':'%s just quit the irc server.',
'5001':'You awake and have a delicious breakfast.',
'5002':'You are ready to go.',
'5003':'The party advanced to level %s.',
'5004':'Your attributes: %s.',
'5005':'%s',
'5006':'Your skills: %s.',
'5007':'Known Places in %s: %s.',
'5008':'Your party has %s: %s.',
...
'5012':'Your asl: %s. Use #%s [<age|bmi|height>] for party sums.',
...
'5025':'%s has left %s.',
'5026':'%s is in your party now.',
'5027':'You explored %s again, but it seems you know every single corner of it.',
'5028':'You explored %s again, but could not find anything new.',
'5029':'%2$s',
'5030':'%s',
...
'5040':'%s ClanMembers page %s/%s: %s.',
'5041':'ClanHistory page %s/%s: %s.',
'5042':'Cmds: %s.',
'5043':'%s',
'5044':'%s',
...
'5088':'%s',
'5089':'%s',
'5090':'%s moves %s meters %s and is now on position %s meters%s',
'5091':'%s moves %s meters %s and is now on position %s meters%s',
'5092':'The enemy party said "bye".',
'5093':'You continue %s',
'5094':'%s thanked you and left the party.',
...
'5160':'Bazaar matches, page %s/%s: %s.',
...
'5182':'The party goes to sleep. You go to your own bedroom.',
...
'5208':'You pay %s and the smith cleans the %s from all its runes. You receive a(n): %s.',
...
'5247':'Active players, page %s of %s: %s.',
'5248':'Active parties, page %s of %s: %s.',
'5249':'Message of the day: %s',
'5250':'You know a new %s: %s.',
'5251':'You now have %s(+%s) karma. With karma you can #%s.',
...
'5284':'%2$s is now outside of the %1$s.',
