<?php
/**
 * This is an example config.php from a dev server.
 * 
 * Auto Generated by GWFv3.02-2011.Oct.25 *
...
define('GWF_SITENAME', 'MyWebsite'); # Your Site`s name. htmlspecialchars() it yourself.
...
### 3rd Party ###
#################
define('GWF_SMARTY_PATH', '/data/_ProjectPDT5/smarty31/libs/Smarty.class.php'); # Smarty - Template Engine
...
### Smarty ###
##############
define('GWF_SMARTY_TPL_DIR', '/data/_ProjectPDT5/GWF33/extra/temp/smarty_cache/tpl'); # Path to smarty template directory.
define('GWF_SMARTY_COMPILE_DIR', '/data/_ProjectPDT5/GWF33/extra/temp/smarty_cache/tplc'); # Path to smarty caching directory.
define('GWF_SMARTY_CACHE_DIR', '/data/_ProjectPDT5/GWF33/extra/temp/smarty_cache/cache'); # Path to smarty cache directory.
define('GWF_SMARTY_CONFIG_DIR', '/data/_ProjectPDT5/GWF33/extra/temp/smarty_cache/cfg'); # Path to smarty config directory.
define('GWF_SMARTY_PLUGINS_DIR', '/data/_ProjectPDT5/GWF33/core/inc/smartyplugins'); # Path to the gwf smarty plugins.
...
### Database ###
################
define('GWF_SECRET_SALT', 'jHD4GylQ0cULXslb'); # May not be changed after install!
...
### Session ###
###############
define('GWF_SESS_NAME', 'WC4'); # Cookie Prefix. Example: 'GWF'.
