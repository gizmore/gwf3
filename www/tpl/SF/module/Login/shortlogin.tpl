...
{*todo tooltip*}	<label for="lf_bind_ip">{$lang->lang('th_bind_ip')}<img class="gwf_tooltip" src="/img/default/lightbulb.png" alt="ToolTip" title="{$lang->lang('tt_bind_ip')}" onclick="alert('{$lang->lang('tt_bind_ip')}');" /></label><input id="lf_bind_ip" type="checkbox" name="bind_ip" checked="checked" value="">
