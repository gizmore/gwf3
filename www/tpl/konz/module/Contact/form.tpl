...
<div id="contact">
	<div class="contact_img">{include file="tpl/default/module/Konzert/mugshot.tpl" small='/tpl/konz/bild/196.jpg' large='/tpl/konz/bild/196_large.jpg' title=$k->lang('name') alt=$k->lang('foto') text=''}</div>
...
<div>
	<div class="contact_img">{include file="tpl/default/module/Konzert/mugshot.tpl" small='/tpl/konz/bild/717.jpg' large='/tpl/konz/bild/717_large.jpg' title=$k->lang('name') alt=$k->lang('foto') text=''}</div>
	<div class="contact">
		<h3>Management:</h3>
