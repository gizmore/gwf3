...
for ($i = 1; $i <= 3; $i++)
{
	...
	echo sprintf('<div style="font-size: 1.125rem; margin-bottom: 20px; margin-top: 40px; margin-left: 50px;">%s</div>', $head);
	
	echo sprintf('<div style="font-size: 1rem; margin-top:20px;">%s</div>', $sub);
