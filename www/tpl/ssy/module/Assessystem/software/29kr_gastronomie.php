...
?>
<?php echo SSYHTML::getBoxTitled($tLang->lang('soft_5_title_1'), $html); ?>
...
<span class="ssy800v_R ssy_st_out3">
	...
	<span class="ssy_st_out3_t ssy800h"><?php echo GWF_String::toUpper($tLang->lang('soft_5_title_1')); ?></span>
