<?php echo SSYHTML::getBoxTitled($tLang->lang('kunde_0_title'),  $tLang->lang('kunde_0_info')); ?>
...
/*	foreach ($tLang->lang('soft_1_3') as $txt)
	...
	<span class="ssy_st_out3_t ssy800h"><?php echo GWF_String::toUpper($tLang->lang('kunde_0_title')); ?></span>
