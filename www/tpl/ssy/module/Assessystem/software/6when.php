<div>
<?php echo SSYHTML::getBoxTitled($tLang->lang('when0_title'), $tLang->lang('when0_info')); ?>
<span class="t" style="">
...
//	}
	...
	<span class="ssy_st_out3_t ssy800h"><?php #echo GWF_String::toUpper($tLang->lang('soft_1_title_2')); ?><?php echo GWF_String::toUpper($tLang->lang(sprintf('when%d_title', $index))); ?></span>
	<span class="ssy800v ssy_st_out2">
		<span class="ssy800v_R ssy_st_out1">
			<?php echo $tLang->lang(sprintf('when%d_info', $index)); ?>
